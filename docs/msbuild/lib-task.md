...
|**ErrorReporting**|선택적 **문자열** 매개 변수입니다.<br /><br /> 런타임 시 *lib.exe*가 실패할 경우 내부 오류 정보를 Microsoft에 보낼 방법을 지정합니다.<br /><br /> 각 명령줄 옵션에 해당하는 다음 값 중 하나를 지정하세요.<br /><br /> -   **NoErrorReport** - **/ERRORREPORT:NONE**<br />-   **PromptImmediately** - **/ERRORREPORT:PROMPT**<br />-   **QueueForNextLogin** - **/ERRORREPORT:QUEUE**<br />-   **SendErrorReport** - **/ERRORREPORT:SEND**<br /><br /> 자세한 내용은 [LIB 실행](/cpp/build/reference/running-lib)에서 **/ERRORREPORT** 명령줄 옵션을 참조하세요.|  
