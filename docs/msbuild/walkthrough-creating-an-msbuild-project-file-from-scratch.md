...
## <a name="create-a-minimal-application"></a>최소 응용 프로그램 만들기  
...
## <a name="use-the-project-file-to-build-the-application"></a>프로젝트 파일을 사용하여 응용 프로그램 빌드  
