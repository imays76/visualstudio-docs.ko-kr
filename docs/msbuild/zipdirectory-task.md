...
ms.locfileid: "37059413"
---
# <a name="zipdirectory-task"></a>ZipDirectory 작업
디렉터리의 콘텐츠에서 `.zip` 보관을 만듭니다.

**참고:** `ZipDirectory` 작업은 MSBuild 15.8 이상에서만 사용할 수 있습니다.
...
|`SourceDirectory`|필수 <xref:Microsoft.Build.Framework.ITaskItem> 매개 변수입니다.<br /><br /> `.zip` 보관을 만들 디렉토리를 지정합니다.|
