...
|`DefaultToVcxPlatformMapping`|선택적 `string` 출력 매개 변수입니다.<br /><br /> 대부분의 형식에 사용되는 플랫폼 이름과 *.vcxproj* 파일에 사용되는 플랫폼 이름 간의 매핑을 세미콜론으로 구분한 목록을 포함합니다.<br /><br /> 예:<br /><br /> `"AnyCPU=Win32;X86=Win32;X64=X64"`|  
