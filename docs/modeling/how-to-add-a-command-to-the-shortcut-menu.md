...
요약 하자면, 단계를 수행 DslPackage 프로젝트에서 다음과 같이 합니다.
...
### <a name="extend-the-commandset-class"></a>CommandSet 클래스를 확장 합니다.
...
명령 (컨텍스트)를 마우스 오른쪽 단추 클릭 메뉴에서 명령을 실행할 다른에 표시 될 때 확인 하는 두 가지 메서드를 정의 해야 합니다. 이러한 메서드는 재정의가 아니며, 명령 목록에 등록해야 합니다.
...
### <a name="define-what-the-command-does"></a>명령을 통해 수행할 작업 정의
 ...
 모델 요소를 변경하는 경우에는 트랜잭션 내에서 변경해야 합니다. 자세한 내용은 [방법: 표준 메뉴 명령 수정](../modeling/how-to-modify-a-standard-menu-command-in-a-domain-specific-language.md)합니다.
...
```
 ...
 개체 및 링크를 만드는 방법에 대 한 모델에서 개체를 이동 하는 방법에 대 한 자세한 내용은 참조 하세요. [방법: 표준 메뉴 명령 수정](../modeling/how-to-modify-a-standard-menu-command-in-a-domain-specific-language.md)합니다.
