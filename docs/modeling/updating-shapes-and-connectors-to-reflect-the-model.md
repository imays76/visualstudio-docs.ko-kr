...
ms.locfileid: "31950415"
---
# <a name="update-shapes-and-connectors-to-reflect-the-model"></a>셰이프 및 연결선은 모델을 반영 하도록 업데이트

에 도메인 특정 언어 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], 기본 모델의 상태를 반영 하는 도형의 모양을 만들 수 있습니다.

이 항목의 코드 예제에 추가할지는 `.cs` 파일 프로그램 `Dsl` 프로젝트. 각 파일에 이러한 문이 필요합니다.
