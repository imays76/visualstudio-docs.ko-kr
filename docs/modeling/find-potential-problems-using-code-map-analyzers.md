...
맵 도구 모음에서 선택 **레이아웃** > **분석기**, 및를 실행 하는 분석기 다음:
...
코드 맵 분석기는 적용한 후 계속 실행됩니다. 맵을 변경하는 경우 적용된 모든 분석기가 업데이트된 맵 자동으로 다시 처리합니다. 맵 도구 모음에서 분석기 실행을 중지 하려면 선택 **레이아웃** > **분석기**합니다. 선택한 분석기를 끕니다.
