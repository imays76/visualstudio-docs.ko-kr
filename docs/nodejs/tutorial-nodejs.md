...
이 자습서에서는 Express를 사용하여 Node.js 앱을 만들고 실행하는 방법 및 디버거를 사용하여 중단점을 적중하는 방법을 배웠습니다. 자세히 알아보려면 [GitHub에서 Visual Studio용 Node.js 도구](https://github.com/Microsoft/nodejstools)를 참조하세요.