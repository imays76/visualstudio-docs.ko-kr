...
ms.locfileid: "53950396"
---
# <a name="emulate-expected-real-world-usage-of-a-website-or-application-in-a-load-test-using-a-test-mix-model"></a>테스트 조합 모델을 사용하여 부하 테스트에서 웹 사이트 또는 애플리케이션의 예상 실제 사용법 에뮬레이트
