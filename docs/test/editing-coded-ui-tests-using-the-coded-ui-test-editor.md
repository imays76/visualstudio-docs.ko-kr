...
9. **모두 찾기** - 응용 프로그램의 컨트롤의 컨트롤 속성 및 중요한 변경을 확인할 수 있습니다.
...
- 경우에 따라 테스트 중인 응용 프로그램의 UI에서 컨트롤이 위치한 지점을 시각화하기 어려울 수 있습니다. 코딩된 UI 테스트 편집기의 기능 중 하나를 사용하면, UI 컨트롤 맵에 나열된 컨트롤을 선택하고 테스트 중인 응용 프로그램에서 해당 컨트롤의 위치를 볼 수 있습니다. 자세한 내용은 이 문서 아래쪽에 있는 [테스트 중인 응용 프로그램에서 UI 컨트롤 찾기](#locate-a-ui-control-in-the-application-under-test)를 참조하세요.
...
## <a name="locate-a-ui-control-in-the-application-under-test"></a>테스트 중인 응용 프로그램에서 UI 컨트롤 찾기
...
> [!NOTE]
> UI 컨트롤을 찾기 전에 먼저, 테스트에 연결된 응용 프로그램이 실행 중인지 확인합니다.
