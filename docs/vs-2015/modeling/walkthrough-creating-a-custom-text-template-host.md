...
ms.locfileid: "47564337"
---
# <a name="walkthrough-creating-a-custom-text-template-host"></a>연습: 사용자 지정 텍스트 템플릿 호스트 만들기
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [연습: 사용자 지정 텍스트 템플릿 호스트 만들기](https://docs.microsoft.com/visualstudio/modeling/walkthrough-creating-a-custom-text-template-host)합니다.  
