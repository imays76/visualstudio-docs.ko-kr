...
ms.locfileid: "47565195"
---
# <a name="update-a-uml-model-from-a-background-thread"></a>백그라운드 스레드에서 UML 모델 업데이트
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [백그라운드 스레드에서 UML 모델 업데이트](https://docs.microsoft.com/visualstudio/modeling/update-a-uml-model-from-a-background-thread)합니다.  
