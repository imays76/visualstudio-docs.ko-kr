---
title: 도메인별 언어 탐색기 작업 | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47555436"
---
# <a name="working-with-the-domain-specific-language-explorer"></a>도메인별 언어 탐색기 작업
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [도메인별 언어 탐색기 작업](https://docs.microsoft.com/visualstudio/modeling/working-with-the-domain-specific-language-explorer)합니다.  
...
-   **연결 작성기**합니다. 모델의 연결 작성기 목록입니다. 연결 작성기에 대 한 자세한 내용은 참조 하세요. [링크 만들기 사용자 지정-리디렉션](../misc/customizing-link-creation-redirection.md)합니다.  
  
-   **커넥터**합니다. 모델의 연결선 다이어그램 요소 목록입니다. 커넥터에 대 한 자세한 내용은 참조 하세요. [종류의 모양 및 연결선-리디렉션](../misc/types-of-shapes-and-connectors-redirect.md)합니다.  
