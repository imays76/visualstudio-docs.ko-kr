...
ms.locfileid: "47555453"
---
# <a name="sample-xsd-file-purchase-order-schema"></a>샘플 XSD 파일: 구매 주문 스키마
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [샘플 XSD 파일: 구매 주문 스키마](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-purchase-order-schema)합니다.  
