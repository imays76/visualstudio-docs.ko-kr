...
ms.locfileid: "47564998"
---
# <a name="context-menus-xml-schema-explorer"></a>상황에 맞는 메뉴(XML 스키마 탐색기)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [상황에 맞는 메뉴 (XML 스키마 탐색기)](https://docs.microsoft.com/visualstudio/xml-tools/context-menus-xml-schema-explorer)합니다.  
