...
ms.locfileid: "47542919"
---
# <a name="walkthrough-using-xslt-intellisense"></a>연습: XSLT IntelliSense 사용
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [연습: XSLT IntelliSense를 사용 하 여](https://docs.microsoft.com/visualstudio/xml-tools/walkthrough-using-xslt-intellisense)입니다.  
