...
에 대해 설명 하는 방법을 사용 하 여는 **규칙 집합 선택** 레거시 대화 상자 [!INCLUDE[wfd1](../includes/wfd1-md.md)]합니다. 레거시 [!INCLUDE[wfd2](../includes/wfd2-md.md)]는 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 또는 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]를 대상으로 해야 하는 경우에 사용합니다.  
 ...
 합니다 **규칙 집합 선택** 대화 상자를 사용 하 여 사용할 수 있는 규칙 집합을 선택 하려면 사용을 [PolicyActivity](http://go.microsoft.com/fwlink?LinkID=65019) 활동입니다. 액세스 하는 방법에 대 한 자세한 합니다 **규칙 집합 선택** 대화 상자, 참조 [방법: PolicyActivity 규칙 집합 (레거시) 만들기](../workflow-designer/how-to-create-a-policyactivity-rule-set-legacy.md).  
...
|**그래**|선택한 규칙 집합을 할당 하려면 클릭 합니다 **PolicyActivity** 활동입니다.|  
