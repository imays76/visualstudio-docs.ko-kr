# [응용 프로그램 품질 분석](analyzing-application-quality-by-using-code-analysis-tools.md)
## [관리 코드 품질 분석](analyzing-managed-code-quality-by-using-code-analysis.md)
### [관리 코드에 대한 코드 분석 개요](code-analysis-for-managed-code-overview.md)
### [방법: 자동 코드 분석 사용 설정 및 해제](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [방법: 전체 솔루션 분석 사용 설정 및 해제](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [자동 기능 일시 중단](automatic-feature-suspension.md)
### [방법: 수동으로 코드 분석 실행](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [방법: 생성된 코드에 대한 경고 표시 안 함](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [CheckId별 경고](code-analysis-warnings-for-managed-code-by-checkid.md)
...
##### [CA2101: P/Invoke 문자열 인수에 대해 마샬링을 지정합니다.](ca2101-specify-marshaling-for-p-invoke-string-arguments.md)
...
##### [CA1404: P-Invoke 다음에 바로 GetLastError를 호출합니다.](ca1404-call-getlasterror-immediately-after-p-invoke.md)
...
##### [CA1414: MarshalAs로 부울 P/Invoke 인수를 표시합니다.](ca1414-mark-boolean-p-invoke-arguments-with-marshalas.md)
##### [CA1415: P-Invoke를 올바르게 선언합니다.](ca1415-declare-p-invokes-correctly.md)
...
##### [CA5122: P/Invoke 선언은 안전에 중요한 선언이 아니어야 합니다.](ca5122-p-invoke-declarations-should-not-be-safe-critical.md)
...
## [C/C++ 코드 품질 분석](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
#### [모범 사례 및 예제](best-practices-and-examples-sal.md)
...
### [방법: 솔루션의 여러 프로젝트에 대한 관리 규칙 집합 지정](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [사용자 지정 규칙 집합 만들기](creating-custom-code-analysis-rule-sets.md)
#### [방법: 사용자 지정 규칙 집합 만들기](how-to-create-a-custom-rule-set.md)
#### [규칙 집합 편집기에서 작업](working-in-the-code-analysis-rule-set-editor.md)
...
#### [관리 코드에 대한 사용자 지정 체크 인 정책 구현](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
