---
title: 'CA1010: 컬렉션 제네릭 인터페이스를 구현 해야 | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47591891"
---
# <a name="ca1010-collections-should-implement-generic-interface"></a>CA1010: 컬렉션은 제네릭 인터페이스를 구현해야 합니다.
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [CA1010: 컬렉션 제네릭 인터페이스를 구현 해야](https://docs.microsoft.com/visualstudio/code-quality/ca1010-collections-should-implement-generic-interface)합니다.
