...
ms.locfileid: "47543964"
---
# <a name="extended-design-guidelines-rules-rule-set-for-managed-code"></a>관리 코드에 대한 확장 디자인 지침 규칙 규칙 집합
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [관리 되는 코드에 대 한 확장 디자인 지침 규칙 규칙 집합](https://docs.microsoft.com/visualstudio/code-quality/extended-design-guidelines-rules-rule-set-for-managed-code)합니다.  
...
|[CA1003](../code-quality/ca1003-use-generic-event-handler-instances.md)|제네릭 이벤트 처리기 인스턴스를 사용 합니다.|  
...
|[CA1024](../code-quality/ca1024-use-properties-where-appropriate.md)|적절 한 속성을 사용 합니다.|  
|[CA1025](../code-quality/ca1025-replace-repetitive-arguments-with-params-array.md)|반복 인수를 배열로 바꾸십시오.|  
|[CA1026](../code-quality/ca1026-default-parameters-should-not-be-used.md)|기본 매개 변수를 사용 하지 않아야|  
|[CA1027](../code-quality/ca1027-mark-enums-with-flagsattribute.md)|열거형을 FlagsAttribute로 표시|  
|[CA1028](../code-quality/ca1028-enum-storage-should-be-int32.md)|열거형 저장소는 Int32 여야 합니다.|  
|[CA1030](../code-quality/ca1030-use-events-where-appropriate.md)|적절 한 이벤트를 사용 합니다.|  
...
|[CA1035](../code-quality/ca1035-icollection-implementations-have-strongly-typed-members.md)|ICollection 구현에 강력한 형식의 멤버가|  
|[CA1036](../code-quality/ca1036-override-methods-on-comparable-types.md)|비교 가능한 형식에 메서드를 재정의 합니다.|  
...
|[CA1046](../code-quality/ca1046-do-not-overload-operator-equals-on-reference-types.md)|참조 형식에 같음 연산자 오버 로드 하지 마십시오.|  
...
|[CA1050](../code-quality/ca1050-declare-types-in-namespaces.md)|네임 스페이스의 형식을 선언 하십시오.|  
|[CA1051](../code-quality/ca1051-do-not-declare-visible-instance-fields.md)|표시 되는 인스턴스 필드 선언 하지 마십시오.|  
...
|[CA1054](../code-quality/ca1054-uri-parameters-should-not-be-strings.md)|URI 매개 변수는 문자열이 면 안 됩니다.|  
...
|[CA1058](../code-quality/ca1058-types-should-not-extend-certain-base-types.md)|형식은 특정 기본 형식을 확장 하면 안|  
|[CA1059](../code-quality/ca1059-members-should-not-expose-certain-concrete-types.md)|멤버는 구체적인 특정 형식을 노출 해야|  
|[CA1064](../code-quality/ca1064-exceptions-should-be-public.md)|예외는 public 이어야 합니다.|  
|[CA1500](../code-quality/ca1500-variable-names-should-not-match-field-names.md)|변수 이름은 필드 이름과 일치 하지는|  
|[CA1502](../code-quality/ca1502-avoid-excessive-complexity.md)|과도 한 복잡성을 방지 합니다.|  
|[CA1708](../code-quality/ca1708-identifiers-should-differ-by-more-than-case.md)|식별자 대/소문자만 달라 야 합니다.|  
|[CA1716](../code-quality/ca1716-identifiers-should-not-match-keywords.md)|식별자는 키워드와 일치|  
|[CA1801](../code-quality/ca1801-review-unused-parameters.md)|사용 되지 않는 매개 변수를 검토|  
|[CA1804](../code-quality/ca1804-remove-unused-locals.md)|사용 되지 않는 로컬 항목을 제거|  
...
|[CA1812](../code-quality/ca1812-avoid-uninstantiated-internal-classes.md)|인스턴스화되지 않은 내부 클래스를 방지 합니다.|  
|[CA1813](../code-quality/ca1813-avoid-unsealed-attributes.md)|봉인 되지 않은 특성|  
|[CA1814](../code-quality/ca1814-prefer-jagged-arrays-over-multidimensional.md)|다차원 보다 가변 배열을 사용합니다|  
|[CA1815](../code-quality/ca1815-override-equals-and-operator-equals-on-value-types.md)|Equals를 재정의 하 고 값 형식에서 equals 또는 같음 연산자|  
...
|[CA2201](../code-quality/ca2201-do-not-raise-reserved-exception-types.md)|예약 된 예외 형식을 발생 하지 않습니다|  
|[CA2205](../code-quality/ca2205-use-managed-equivalents-of-win32-api.md)|관리 되는 Win32 api를 사용 합니다.|  
|[CA2208](../code-quality/ca2208-instantiate-argument-exceptions-correctly.md)|인수 예외를 올바르게 인스턴스화|  
...
|[CA1020](../code-quality/ca1020-avoid-namespaces-with-few-types.md)|몇 가지 형식과 네임 스페이스를 방지 합니다.|  
...
|[CA1501](../code-quality/ca1501-avoid-excessive-inheritance.md)|과도 한 상속을 방지|  
|[CA1504](../code-quality/ca1504-review-misleading-field-names.md)|잘못 된 필드 이름을 검토 하십시오.|  
|[CA1505](../code-quality/ca1505-avoid-unmaintainable-code.md)|유지 관리할 수 없는 코드를 방지 합니다.|  
|[CA1506](../code-quality/ca1506-avoid-excessive-class-coupling.md)|클래스 결합을 방지|  
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|열거형 값 ' 이름을 바꾸지 마십시오|  
|[CA1701](../code-quality/ca1701-resource-string-compound-words-should-be-cased-correctly.md)|리소스 문자열 복합 단어에는 올바르게 표기를 사용 해야|  
|[CA1702](../code-quality/ca1702-compound-words-should-be-cased-correctly.md)|복합 단어에는 올바르게 표기를 사용 해야|  
...
|[CA1709](../code-quality/ca1709-identifiers-should-be-cased-correctly.md)|식별자에는 올바르게 표기를 사용 해야|  
|[CA1710](../code-quality/ca1710-identifiers-should-have-correct-suffix.md)|식별자에는 올바른 접미사를 사용 해야 합니다.|  
|[CA1711](../code-quality/ca1711-identifiers-should-not-have-incorrect-suffix.md)|식별자에는 접미사를 사용 해야 합니다.|  
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|열거형 값 형식 이름의 접두사로 사용 하지 마세요|  
|[CA1713](../code-quality/ca1713-events-should-not-have-before-or-after-prefix.md)|이벤트에는 before 또는 after 접두사 없어야|  
...
|[CA1719](../code-quality/ca1719-parameter-names-should-not-match-member-names.md)|매개 변수 이름은 멤버 이름과 일치 하지는|  
|[CA1720](../code-quality/ca1720-identifiers-should-not-contain-type-names.md)|식별자에 형식 이름을 포함 해야 합니다.|  
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|속성 이름은 get 메서드와 달라 야 합니다.|  
|[CA1722](../code-quality/ca1722-identifiers-should-not-have-incorrect-prefix.md)|식별자에는 잘못 된 접두사를 사용 해야 합니다.|  
...
|[CA1726](../code-quality/ca1726-use-preferred-terms.md)|기본 설정된 용어를 사용 합니다.|  
