...
3.  선택한 구성을 사용 하 여 프로젝트를 빌드할 때마다 코드 분석을 실행 하려면 선택 합니다 **C/c + + 빌드에 대 한 코드 분석 사용** 확인란 합니다. 열어 코드 분석을 수동으로 실행할 수도 있습니다는 **분석** 메뉴를 선택한 다음 **에 대해 코드 분석 실행** *ProjectName*합니다.  
