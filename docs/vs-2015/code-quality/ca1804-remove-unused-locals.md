...
ms.locfileid: "47591292"
---
# <a name="ca1804-remove-unused-locals"></a>CA1804: 사용되지 않는 로컬 항목을 제거하십시오.
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [CA1804: 사용 되지 않는 로컬 항목을 제거](https://docs.microsoft.com/visualstudio/code-quality/ca1804-remove-unused-locals)합니다.
