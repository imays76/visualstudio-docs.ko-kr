...
이 항목의 최신 버전에서 찾을 수 있습니다 [CA2142: 투명 코드는 LinkDemands를 사용 하 여 보호 해서는 안](https://docs.microsoft.com/visualstudio/code-quality/ca2142-transparent-code-should-not-be-protected-with-linkdemands)합니다.
