...
이 항목의 최신 버전에서 찾을 수 있습니다 [CA2140: 투명 코드는 보안에 중요 한 항목을 참조 하지 않아야](https://docs.microsoft.com/visualstudio/code-quality/ca2140-transparent-code-must-not-reference-security-critical-items)합니다.
