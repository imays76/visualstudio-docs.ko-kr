...
|[Microsoft Web 개발자 도구 2013](http://go.microsoft.com/fwlink/?LinkId=328952)|Microsoft Web Developer Tools 2013|  
...
|[WCF RIA 서비스 v1.0 SP2](http://go.microsoft.com/fwlink/?LinkId=328955)|WCF RIA Services v1.0 SP2|  
...
|[Microsoft Azure](http://support.microsoft.com/gp/azure-cloud-lifecycle-faq)<br /><br /> <br />> 참고: [온라인 수명 주기 정책](http://support.microsoft.com/gp/OSSLpolicy)|Microsoft Azure 모바일 서비스 SDK<br /><br /> Microsoft Azure 모바일 서비스 도구|