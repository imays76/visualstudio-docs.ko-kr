...
ms.locfileid: "47549700"
---
# <a name="how-to-create-a-geometry-based-gradient-shader"></a>방법: 기하 도형 기반 그라데이션 셰이더 만들기
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 기 하 도형 기반 그라데이션 셰이더 만들기](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-geometry-based-gradient-shader)합니다.  
