...
ms.locfileid: "47544041"
---
# <a name="direct-selection-tool-modifier-keys-in-blend"></a>Blend의 직접 선택 도구 보조 키
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [Blend의 직접 선택 도구 보조 키](https://docs.microsoft.com/visualstudio/designers/direct-selection-tool-modifier-keys-in-blend)합니다.  
