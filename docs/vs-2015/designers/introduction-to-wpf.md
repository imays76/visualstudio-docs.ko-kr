...
ms.locfileid: "47565388"
---
# <a name="introduction-to-wpf"></a>WPF 소개
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [의 WPF 소개](https://docs.microsoft.com/visualstudio/designers/introduction-to-wpf)합니다.  
...
### <a name="2-d-geometries"></a>2차원 기하 도형  
 ...
 자세한 내용은 [기하 도형 개요](https://msdn.microsoft.com/library/ms751808\(v=vs.100\).aspx)를 참조하세요.  
...
### <a name="2-d-effects"></a>2차원 효과  
 ...
 자세한 내용은 [WPF 브러시 개요](https://msdn.microsoft.com/library/aa970904\(v=vs.100\).aspx)를 참조하세요.  
...
### <a name="images"></a>이미지  
 ...
 자세한 내용은 [이미징 개요](https://msdn.microsoft.com/library/ms748873\(v=vs.100\).aspx)를 참조하세요.  
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/DataTemplateWindow.xaml#datatemplatemarkup4)]  
 ...
 자세한 내용은 [데이터 템플릿 개요](https://msdn.microsoft.com/library/ms742521\(v=vs.100\).aspx)를 참조하세요.  
