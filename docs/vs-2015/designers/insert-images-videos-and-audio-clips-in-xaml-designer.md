...
이미지, 비디오 및 오디오 클립은 앱에 시각적 효과를 추가합니다.  
 ...
 ![크기에 맞게 조정된 이미지](../designers/media/b5-memory-images-sized.png "b5_memory_images_sized")  
...
|작업|짧은 비디오 보기|  
|----------|-------------------------|  
|Adobe FXG 파일 가져오기|![설치된 기능 구성](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Blend의 FXG 가져오기 미리 보기](http://www.bing.com/videos/search?q=blend%20import%20FXG%20file&qs=n&form=QBVR&pq=blend%20import%20fxg%20file&sc=0-13&sp=-1&sk=#view=detail&mid=3C733B0B50A43166C55C3C733B0B50A43166C55C)|  
