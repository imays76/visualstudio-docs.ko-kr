...
## <a name="file-location"></a>파일 위치  
 ...
 항상 응용 프로그램 매니페스트는 배포 하기 전에 서명 되어야 합니다. 응용 프로그램 매니페스트를 수동으로 변경한 경우 mage.exe를 사용 하 여 응용 프로그램 매니페스트에 다시 서명, 배포 매니페스트를 업데이트 및 배포 매니페스트에 다시 서명 해야 합니다. 자세한 내용은 [연습: ClickOnce 응용 프로그램 수동 배포](../deployment/walkthrough-manually-deploying-a-clickonce-application.md)합니다.  
