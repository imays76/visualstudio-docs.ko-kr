...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 배포 응용 프로그램을 실행할 수 있는 여러 버전의.NET Framework에서 사용 하 여 ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-use-clickonce-to-deploy-applications-that-can-run-on-multiple-versions-of-the-dotnet-framework)합니다.  
