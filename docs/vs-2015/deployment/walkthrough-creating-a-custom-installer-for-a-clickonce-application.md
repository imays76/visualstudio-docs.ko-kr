...
이 항목의 최신 버전에서 찾을 수 있습니다 [연습: ClickOnce 응용 프로그램에 대 한 사용자 지정 설치 관리자 만들기](https://docs.microsoft.com/visualstudio/deployment/walkthrough-creating-a-custom-installer-for-a-clickonce-application)합니다.  
