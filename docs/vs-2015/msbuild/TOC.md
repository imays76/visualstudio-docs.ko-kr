...
#### [인라인 작업](msbuild-inline-tasks.md)
...
## [고급 개념](msbuild-advanced-concepts.md)
### [일괄 처리](msbuild-batching.md)
#### [작업 일괄 처리의 항목 메타데이터](item-metadata-in-task-batching.md)
#### [대상 일괄 처리의 항목 메타데이터](item-metadata-in-target-batching.md)
### [변환](msbuild-transforms.md)
### [Visual Studio 통합](visual-studio-integration-msbuild.md)
...
### [병렬로 여러 프로젝트 빌드](building-multiple-projects-in-parallel-with-msbuild.md)
...
### [멀티 타기팅](msbuild-multitargeting-overview.md)
#### [도구 집합(ToolsVersion)](msbuild-toolset-toolsversion.md)
...
#### [대상 프레임워크 및 대상 플랫폼](msbuild-target-framework-and-target-platform.md)
...
### [모범 사례](msbuild-best-practices.md)
## [MSBuild의 로그인](logging-in-msbuild.md)
### [빌드 로그 가져오기](obtaining-build-logs-with-msbuild.md)
...
### [프로젝트 파일 스키마 참조](msbuild-project-file-schema-reference.md)
...
### [작업 참조](msbuild-task-reference.md)
#### [Visual C++ 태스크](msbuild-tasks-specific-to-visual-cpp.md)
...
### [조건](msbuild-conditions.md)
### [조건부 구문](msbuild-conditional-constructs.md)
### [예약된 속성 및 잘 알려진 속성](msbuild-reserved-and-well-known-properties.md)
### [일반적인 MSBuild 프로젝트 속성](common-msbuild-project-properties.md)
### [일반적인 MSBuild 프로젝트 항목](common-msbuild-project-items.md)
### [명령줄 참조](msbuild-command-line-reference.md)
### [.Targets 파일](msbuild-dot-targets-files.md)
### [잘 알려진 항목 메타데이터](msbuild-well-known-item-metadata.md)
### [지시 파일](msbuild-response-files.md)
### [추가 리소스](additional-resources-for-msbuild.md)
### [WPF MSBuild 참조](wpf-msbuild-reference.md)
#### [.Targets 파일](wpf-dot-targets-files.md)
#### [작업 참조](wpf-msbuild-task-reference.md)
...
## [용어](msbuild-glossary1.md)
## [추가 리소스](additional-msbuild-resources.md)
