...
ms.locfileid: "47564988"
---
# <a name="assignprojectconfiguration-task"></a>AssignProjectConfiguration 작업
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [AssignProjectConfiguration 작업](https://docs.microsoft.com/visualstudio/msbuild/assignprojectconfiguration-task)합니다.  
