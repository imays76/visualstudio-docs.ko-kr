...
ms.locfileid: "47564975"
---
# <a name="aspnetcompiler-task"></a>AspNetCompiler 작업
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [ASP.NET 응용 프로그램을 미리 컴파일할 AspNetCompiler 작업을 사용 하 여](https://docs.microsoft.com/visualstudio/msbuild/aspnetcompiler-task)입니다.  
  
  
`AspNetCompiler` 작업은 [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] 응용 프로그램을 미리 컴파일하는 유틸리티인 aspnet_compiler.exe를 래핑합니다.  
...
## <a name="example"></a>예제  
 다음 코드 예제에서는 `AspNetCompiler` 작업을 사용하여 [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] 응용 프로그램을 미리 컴파일합니다.  
