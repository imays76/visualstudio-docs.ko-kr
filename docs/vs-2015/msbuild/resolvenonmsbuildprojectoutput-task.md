...
ms.locfileid: "47551075"
---
# <a name="resolvenonmsbuildprojectoutput-task"></a>ResolveNonMSBuildProjectOutput 작업
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [ResolveNonMSBuildProjectOutput 작업](https://docs.microsoft.com/visualstudio/msbuild/resolvenonmsbuildprojectoutput-task)합니다.  
