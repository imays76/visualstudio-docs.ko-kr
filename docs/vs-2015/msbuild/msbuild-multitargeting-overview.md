...
ms.locfileid: "47552260"
---
# <a name="msbuild-multitargeting-overview"></a>MSBuild 멀티 타기팅 개요
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [MSBuild 멀티 타기 팅 개요](https://docs.microsoft.com/visualstudio/msbuild/msbuild-multitargeting-overview)합니다.  
...
> [!IMPORTANT]
>  이름이 "멀티 타기 팅"에 불구 하 고 프로젝트가 하나의 프레임 워크와 하나의 플랫폼만 한 번에 대상 수 있습니다.  
