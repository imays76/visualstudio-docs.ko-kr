...
ms.locfileid: "47554476"
---
# <a name="generatedeploymentmanifest-task"></a>GenerateDeploymentManifest 작업
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [GenerateDeploymentManifest 작업](https://docs.microsoft.com/visualstudio/msbuild/generatedeploymentmanifest-task)합니다.  
