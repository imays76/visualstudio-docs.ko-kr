 ...
 **속성 창의 매개 변수 속성**  
 ...
 속성 창에는 **이름**, **형식**, **한정자**, **요약** 및 **선택적 기본값**과 같이 클래스 세부 내용 창에 표시되는 것과 동일한 매개 변수 속성이 표시됩니다. 특정 위치에서 속성을 변경하면 해당 속성의 값이 전역으로 업데이트되어 다른 위치에 있는 해당 값에도 반영됩니다.  
