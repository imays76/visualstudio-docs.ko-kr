...
ms.locfileid: "47555971"
---
# <a name="step-3-add-a-countdown-timer"></a>3단계: 카운트다운 타이머 추가
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [3 단계: 카운트다운 타이머 추가](https://docs.microsoft.com/visualstudio/ide/step-3-add-a-countdown-timer)합니다.  
...
7.  프로그램을 저장하고 실행한 후 폼에서 **시작** 단추를 선택합니다.  
     ...
     ![진행 중인 수학 퀴즈](../ide/media/express-addcountdown.png "Express_AddCountdown")  
진행 중인 수학 퀴즈  
