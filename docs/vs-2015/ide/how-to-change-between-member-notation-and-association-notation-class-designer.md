...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 변경 간에 멤버 표기법과 연결 표기법 (클래스 디자이너)](https://docs.microsoft.com/visualstudio/ide/how-to-change-between-member-notation-and-association-notation-class-designer)합니다.  
