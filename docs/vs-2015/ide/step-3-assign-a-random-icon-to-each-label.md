...
ms.locfileid: "47549411"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>3단계: 각 레이블에 임의 아이콘 할당
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [3 단계: 각 레이블에 임의 아이콘 할당](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label)합니다.  
