...
ms.locfileid: "47556811"
---
# <a name="designing-classes-and-types-class-designer"></a>클래스 및 형식 디자인(클래스 디자이너)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [디자인 클래스 및 형식 (클래스 디자이너)](https://docs.microsoft.com/visualstudio/ide/designing-classes-and-types-class-designer)합니다.  
