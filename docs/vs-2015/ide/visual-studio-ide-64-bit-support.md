...
## <a name="debugging-a-64-bit-application"></a>64비트 응용 프로그램 디버그
 [!INCLUDE[vsprvslong](../includes/vsprvslong-md.md)]가 64비트 Windows 운영 체제에서 실행되고 있으면 편집 및 계속이 작동하지 않습니다. 다음 항목에서는 64비트 응용 프로그램을 디버그하는 방법을 설명합니다.
