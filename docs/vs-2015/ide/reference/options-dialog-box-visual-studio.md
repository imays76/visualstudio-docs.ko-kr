...
ms.locfileid: "47555113"
---
# <a name="options-dialog-box-visual-studio"></a>옵션 대화 상자(Visual Studio)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [옵션 대화 상자 (Visual Studio)](https://docs.microsoft.com/visualstudio/ide/reference/options-dialog-box-visual-studio)합니다.  
