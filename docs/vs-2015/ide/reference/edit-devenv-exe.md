...
ms.locfileid: "47565167"
---
# <a name="edit-devenvexe"></a>/Edit (devenv.exe)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [-Edit (devenv.exe)](https://docs.microsoft.com/visualstudio/ide/reference/edit-devenv-exe)합니다.  
...
## <a name="arguments"></a>인수  
 `file1`  
 선택 사항입니다. [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]의 기존 인스턴스에서 열 파일입니다. [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]의 인스턴스가 없으면 간소화된 창 레이아웃으로 새 인스턴스가 만들어지고 `file1`이 새 인스턴스에서 열립니다.  
