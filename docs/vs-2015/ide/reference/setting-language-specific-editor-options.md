...
ms.locfileid: "47554322"
---
# <a name="setting-language-specific-editor-options"></a>언어별 편집기 옵션 설정
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [언어별 편집기 옵션 설정](https://docs.microsoft.com/visualstudio/ide/reference/setting-language-specific-editor-options)합니다.  
