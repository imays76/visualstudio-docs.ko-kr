...
```  
 ...
 자세한 내용은 [HTML Div 컨트롤](http://msdn.microsoft.com/library/585fa702-4408-4af1-a92b-68d77ee5e995)를 [Label 웹 서버 컨트롤 개요](http://msdn.microsoft.com/library/990558d1-4b22-4f28-b100-78a434b3c5ac), 및 <xref:System.Web.UI.WebControls.Label>합니다.  
