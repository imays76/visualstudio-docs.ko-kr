...
이 항목의 최신 버전에서 찾을 수 있습니다 [키보드 및 마우스 바로 가기 클래스 다이어그램 및 클래스 세부 내용 창 (클래스 디자이너)](https://docs.microsoft.com/visualstudio/ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer)합니다.  
