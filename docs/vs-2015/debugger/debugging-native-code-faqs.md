...
ms.locfileid: "47556512"
---
# <a name="debugging-native-code-faqs"></a>네이티브 코드 디버깅 FAQ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [네이티브 코드 디버깅 Faq](https://docs.microsoft.com/visualstudio/debugger/debugging-native-code-faqs)합니다.  
...
-   [어떻게 확인할 수 있나요 포인터는 메모리 주소를 손상 시키는 지?](../debugger/how-can-i-find-out-if-my-pointers-corrupt-a-memory-address-q.md)  
  
-   [무엇이 잘못된 매개 변수 값을 전달하는지 어떻게 알 수 있나요?](../debugger/how-can-i-find-out-who-is-passing-a-wrong-parameter-value-q.md)  
  
-   [함수를 수백 번 실패 한 호출 하는 호출 하는 경우?](../debugger/when-calling-a-function-hundreds-of-times-how-do-i-know-which-call-failed-q.md)  
