...
ms.locfileid: "47565177"
---
# <a name="debug-hook-function-writing"></a>디버그 후크 함수 작성
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [디버그 후크 함수 작성](https://docs.microsoft.com/visualstudio/debugger/debug-hook-function-writing)합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 내부 메모리를 할당하는 C 런타임 라이브러리 함수를 호출할 때 `_CRT_BLOCK` 블록을 명시적으로 무시하는 할당 후크 함수에 대한 제한 사항에 대해 설명합니다. 할당 후크 무시 하지 않으면도이 항목에서는 결과 나열 `_CRT_BLOCK` 블록 (예제) 및 기본 할당을 변경 하는 방법에 대 한 후크 함수 **CrtDefaultAllocHook**합니다.  
