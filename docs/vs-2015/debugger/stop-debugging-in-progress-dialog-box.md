 ...
 **지금 중지**  
 디버깅 세션을 즉시 종료하려면 이 단추를 클릭합니다. 사용 하 여 **지금 중지**디버깅 중인 프로세스를 분리 하는 것이 아니라 종료 됩니다. 시스템 프로세스를 디버깅 하는 경우 사용 하 여 프로세스를 종료 **지금 중지** 있습니다 예기치 않은 결과가 발생할된 합니다.  
