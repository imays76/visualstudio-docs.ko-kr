...
이 항목의 최신 버전에서 찾을 수 있습니다 [(JavaScript) Visual Studio에서 스토어 앱에 대 한 디버깅 세션을 시작](https://docs.microsoft.com/visualstudio/debugger/start-a-debugging-session-for-store-apps-in-visual-studio-javascript)합니다.  
