...
ms.locfileid: "47555216"
---
# <a name="unable-to-connect-to-the-microsoft-visual-studio-remote-debugging-monitor"></a>Unable to Connect to the Microsoft Visual Studio Remote Debugging Monitor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [Microsoft Visual Studio 원격 디버깅 모니터에 연결할 수 없습니다](https://docs.microsoft.com/visualstudio/debugger/unable-to-connect-to-the-microsoft-visual-studio-remote-debugging-monitor)합니다.  
...
## <a name="the-local-and-remote-machines-have-different-authentication-modes"></a>로컬 및 원격 컴퓨터의 인증 모드가 서로 다름  
 ...
 인증 모드에 대 한 자세한 내용은 참조 하세요. [Windows 인증 개요](https://technet.microsoft.com/library/hh831472.aspx)합니다.  
