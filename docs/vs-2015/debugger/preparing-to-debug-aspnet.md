...
ms.locfileid: "47543211"
---
# <a name="preparing-to-debug-aspnet"></a>ASP.NET 디버깅 준비
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [ASP.NET 디버그 준비](https://docs.microsoft.com/visualstudio/debugger/preparing-to-debug-aspnet)합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [웹 응용 프로그램 원격 디버깅의 필수 조건](../debugger/prerequistes-for-remote-debugging-web-applications.md)  
 원격 서버에서 웹 응용 프로그램을 디버깅할 때 필수 조건을 열거합니다.  
  
 [방법: Windows Server 2003에서 IIS를 구성 합니다.](http://msdn.microsoft.com/en-us/23d557c5-ffcb-4fb2-be7c-5901d5f72ea1)  
