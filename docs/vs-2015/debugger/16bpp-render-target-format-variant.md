...
ms.locfileid: "47553129"
---
# <a name="16bpp-render-target-format-variant"></a>16bpp 렌더링 대상 형식 변형
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [16bpp 렌더링 대상 형식 변형](https://docs.microsoft.com/visualstudio/debugger/graphics/16bpp-render-target-format-variant)합니다.  
