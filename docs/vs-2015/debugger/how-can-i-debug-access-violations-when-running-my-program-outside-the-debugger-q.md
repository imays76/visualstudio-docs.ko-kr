...
이 항목의 최신 버전에서 찾을 수 있습니다 [어떻게 해야 합니까 디버그 액세스 위반 때 실행 내 프로그램 외부에서 디버거?](https://docs.microsoft.com/visualstudio/debugger/how-can-i-debug-access-violations-when-running-my-program-outside-the-debugger-q)합니다.  
