...
이 항목의 최신 버전에서 찾을 수 있습니다 [동시성 시각화 도우미 명령줄 유틸리티 (CVCollectionCmd)](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-command-line-utility-cvcollectioncmd)합니다.  
