...
ms.locfileid: "47555100"
---
# <a name="markerserieswriteflag-method"></a>marker_series::write_flag 메서드
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [marker_series:: write_flag 메서드](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-flag-method)합니다.  
