...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 명령줄을 사용 하 여는 Profiler 사용 하 여 메모리 데이터 수집을 독립 실행형.NET Framework 구성 요소를 계측](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-stand-alone-dotnet-framework-component-and-collect-memory-data-with-the-profiler-by-using-the-command-line)합니다.  
  
이 항목은 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 프로파일링 도구 명령줄 도구를 사용하여 .exe 또는 .dll 파일과 같은 독립 실행형 응용 프로그램의 .NET Framework 구성 요소를 계측하고 프로파일러를 사용하여 메모리 정보를 수집하는 방법을 설명합니다.  
