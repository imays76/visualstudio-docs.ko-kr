...
ms.locfileid: "47556466"
---
# <a name="how-to-filter-profiling-tools-report-views-to-display-just-my-code"></a>방법: 내 코드만 표시하도록 프로파일링 도구 보고서 뷰 필터링
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 프로 파일링 도구 보고서 뷰 필터링 내 코드만 표시 하도록](https://docs.microsoft.com/visualstudio/profiling/how-to-filter-profiling-tools-report-views-to-display-just-my-code)합니다.  
