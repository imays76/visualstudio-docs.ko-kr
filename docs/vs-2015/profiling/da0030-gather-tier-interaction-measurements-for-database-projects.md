...
이 항목의 최신 버전에서 찾을 수 있습니다 [DA0030: 데이터베이스 프로젝트에 대 한 수집 계층 상호 작용 측정값](https://docs.microsoft.com/visualstudio/profiling/da0030-gather-tier-interaction-measurements-for-database-projects)합니다.  
  
규칙 Id | DA0030 |  
| 범주 | 프로 파일링 도구 사용 |  
| 프로 파일링 방법을 | 샘플링 |  
| 메시지 | 다중 계층 응용 프로그램에 대 한 상호 작용 측정값 수집 데이터베이스 사용 패턴과 주요 데이터를 이해할 수 있도록 돕는 액세스 하는 지연입니다. 계층 상호작용 프로 파일링 옵션을 설정한 상태로 응용 프로그램을 다시 프로 파일링 해 보세요. |  
| 규칙 유형 | 정보 |  
