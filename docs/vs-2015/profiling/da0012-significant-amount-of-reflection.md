...
ms.locfileid: "47550441"
---
# <a name="da0012-significant-amount-of-reflection"></a>DA0012: 리플렉션 양이 많습니다.
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [DA0012: 리플렉션 양이 많습니다](https://docs.microsoft.com/visualstudio/profiling/da0012-significant-amount-of-reflection)합니다.  
  
규칙 Id | DA0012 |  
| 범주. NET Framework 사용 |  
| 프로 파일링 방법 | 샘플링 |  
| 메시지 | 사용할 수 있습니다 리플렉션을 과도 하 게 합니다. 이 작업은 비용이 많이 드는 작업입니다. |  
| 규칙 유형 | 경고 |  
