...
이 항목의 최신 버전에서 찾을 수 있습니다 [DA0505: 프로 파일링 중인 프로세스에 할당 된 평균 전용 바이트](https://docs.microsoft.com/visualstudio/profiling/da0505-average-private-bytes-allocated-for-the-process-being-profiled)합니다.  
  
규칙 Id | DA0505 |  
| 범주 | 리소스 관리 |  
| 프로 파일링 방법을 | 모든 |  
| 메시지 | 이 정보는 참고용 으로만 수집 되었습니다. Process Private Bytes 카운터는 프로파일링하고 있는 프로세스에 의해 할당된 가상 메모리를 측정합니다. 보고 된 값은 모든 측정 간격에 걸쳐 계산 된 평균값입니다. |  
| 규칙 유형 | 정보 |  
