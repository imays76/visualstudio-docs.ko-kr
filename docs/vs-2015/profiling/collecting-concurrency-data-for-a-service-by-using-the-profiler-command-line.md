...
이 항목의 최신 버전에서 찾을 수 있습니다 [Profiler 명령줄을 사용 하 여 서비스에 대 한 동시성 데이터 수집](https://docs.microsoft.com/visualstudio/profiling/collecting-concurrency-data-for-a-service-by-using-the-profiler-command-line)합니다.  
