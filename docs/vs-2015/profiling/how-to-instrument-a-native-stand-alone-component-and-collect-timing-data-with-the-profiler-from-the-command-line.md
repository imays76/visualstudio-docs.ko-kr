...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 네이티브 독립 실행형 구성 요소 계측 및 명령줄에서 Profiler 사용 하 여 타이밍 데이터 수집](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line)합니다.  
