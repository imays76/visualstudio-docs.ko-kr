...
ms.locfileid: "47556373"
---
# <a name="report-based-on-visible-time-range"></a>표시되는 시간 범위를 기반으로 하는 보고서
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [Visible 시간 범위를 기반으로 보고서](https://docs.microsoft.com/visualstudio/profiling/report-based-on-visible-time-range)합니다.  
