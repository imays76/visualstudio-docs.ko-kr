...
ms.locfileid: "47555840"
---
# <a name="understanding-instrumentation-data-values"></a>계측 데이터 값 이해
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [계측 데이터 값 이해](https://docs.microsoft.com/visualstudio/profiling/understanding-instrumentation-data-values)합니다.  
