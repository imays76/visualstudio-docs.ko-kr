...
ms.locfileid: "47555523"
---
# <a name="functions-view---net-memory-sampling-data"></a>함수 뷰 - .NET 메모리 샘플링 데이터
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [함수 뷰-.NET 메모리 샘플링 데이터](https://docs.microsoft.com/visualstudio/profiling/functions-view-dotnet-memory-sampling-data)입니다.  
