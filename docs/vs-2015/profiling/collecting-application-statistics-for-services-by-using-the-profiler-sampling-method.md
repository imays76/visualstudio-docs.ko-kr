...
이 항목의 최신 버전에서 찾을 수 있습니다 [Profiler 샘플링 방법을 사용 하 여 서비스에 대 한 응용 프로그램 통계 수집](https://docs.microsoft.com/visualstudio/profiling/collecting-application-statistics-for-services-by-using-the-profiler-sampling-method)합니다.  
