...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: 명령줄 Profiler를 사용 하 여 자세한 타이밍 데이터 수집을 네이티브 서비스 계측](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-native-service-and-collect-detailed-timing-data-by-using-the-profiler-command-line)합니다.  
