...
## <a name="create-a-new-relation-between-tables"></a>테이블 간에 새 관계를 만들려면  
 ...
 ![계층적 업데이트 추가 관계가 메뉴](../data-tools/media/hierarchical-update-add-relation-menu.png "계층적 업데이트 관계가 메뉴 추가")  
...
## <a name="tableadaptermanager-reference"></a>TableAdapterManager 참조  
 ...
 `TableAdapterManager` 클래스가 아닌 부분을 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]입니다. 따라서 설명서에서를 찾을 수 없습니다. 데이터 집합 만들기 프로세스의 일부로 디자인 타임에 생성 됩니다.  
