...
#### [데이터 집합 만들기 및 구성](create-and-configure-datasets-in-visual-studio.md)
...
#### [n 계층 애플리케이션에서 데이터 집합 작업](work-with-datasets-in-n-tier-applications.md)
##### [n 계층 데이터 집합에 유효성 검사 추가](add-validation-to-an-n-tier-dataset.md)
##### [n 계층 애플리케이션에서 데이터 집합에 코드 추가](add-code-to-datasets-in-n-tier-applications.md)
