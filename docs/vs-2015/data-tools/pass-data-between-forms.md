...
ms.locfileid: "47553378"
---
# <a name="pass-data-between-forms"></a>폼 간에 데이터 전달
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [폼 간에 데이터 전달](https://docs.microsoft.com/visualstudio/data-tools/pass-data-between-forms)합니다.  
...
-   항목을 끌어 데이터 바인딩된 컨트롤을 만듭니다는 **데이터 원본** 창에서 폼입니다.  
...
4.  에 **데이터베이스 모델 선택** 페이지에서 **데이터 집합** 를 지정 하 고 클릭 **다음**합니다.  
...
6.  데이터베이스 암호를 요구 하는 경우 및 중요 한 데이터를 포함 하는 옵션을 사용 하는 경우 옵션을 선택한 다음 클릭 **다음**합니다.  
  
7.  에 **응용 프로그램 구성 파일에 연결 문자열을 저장** 페이지에서 클릭 **다음**합니다.  
  
8.  에 **데이터베이스 개체 선택** 페이지에서 확장을 **테이블** 노드.  
  
9. 선택 합니다 **고객** 및 **주문** 테이블과 클릭 **마침**합니다.  
...
-   주를 끌어 **고객** 에서 노드를 **데이터 원본** 창만 **Form1**합니다.  
     ...
     A <xref:System.Windows.Forms.DataGridView> 및 도구 모음 (<xref:System.Windows.Forms.BindingNavigator>)에 표시할 레코드 탐색을 위한 **Form1**합니다. A [NorthwindDataSet](../data-tools/dataset-tools-in-visual-studio.md)를 [CustomersTableAdapter](../data-tools/tableadapter-overview.md)를 <xref:System.Windows.Forms.BindingSource>, 및 <xref:System.Windows.Forms.BindingNavigator> 구성 요소 트레이에 나타납니다.  
...
2.  기본 이름을 그대로 **Form2**, 클릭 **추가**합니다.  
  
3.  주를 끌어 **주문을** 에서 노드를 **데이터 원본** 창만 **Form2**합니다.  
  
     A <xref:System.Windows.Forms.DataGridView> 및 도구 모음 (<xref:System.Windows.Forms.BindingNavigator>)에 표시할 레코드 탐색을 위한 **Form2**합니다. A [NorthwindDataSet](../data-tools/dataset-tools-in-visual-studio.md)를 [CustomersTableAdapter](../data-tools/tableadapter-overview.md)를 <xref:System.Windows.Forms.BindingSource>, 및 <xref:System.Windows.Forms.BindingNavigator> 구성 요소 트레이에 나타납니다.  
...
2.  마우스 오른쪽 단추로 클릭 합니다 **OrdersTableAdapter**, 선택한 **쿼리 추가**합니다.  
  
3.  기본 옵션인 **사용 하 여 SQL 문을**를 클릭 하 고 **다음**합니다.  
  
4.  기본 옵션인 **행을 반환 하는 SELECT**를 클릭 하 고 **다음**합니다.  
  
5.  반환할 쿼리에 WHERE 절을 추가 `Orders` 기반 된 `CustomerID`합니다. 이 쿼리는 다음과 같아야 합니다.  
...
8.  선택을 취소 합니다 **DataTable 반환** 옵션을 선택한 다음 클릭 **다음**합니다.  
...
3.  두 번 클릭 합니다 **CellDoubleClick** 이벤트입니다.  
