...
이 항목의 최신 버전에서 찾을 수 있습니다 [DataContext 메서드의 반환 형식 변경 작업은 실행 취소할 수 없습니다](https://docs.microsoft.com/visualstudio/data-tools/changing-the-return-type-of-a-datacontext-method-cannot-be-undone)합니다.  
