...
ms.locfileid: "47550006"
---
# <a name="add-validation-to-an-n-tier-dataset"></a>n 계층 데이터 집합에 유효성 검사 추가
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [n 계층 데이터 집합에 유효성 검사 추가](https://docs.microsoft.com/visualstudio/data-tools/add-validation-to-an-n-tier-dataset)합니다.  
