...
이 항목의 최신 버전에서 찾을 수 있습니다 [방법: DataContext 메서드 (O-r 디자이너)의 반환 형식을 변경](https://docs.microsoft.com/visualstudio/data-tools/how-to-change-the-return-type-of-a-datacontext-method-o-r-designer)합니다.  
