...
이 항목의 최신 버전에서 찾을 수 있습니다 [FullClassName 요소 (Visual Studio 템플릿 마법사 확장명)](https://docs.microsoft.com/visualstudio/extensibility/fullclassname-element-visual-studio-template-wizard-extension)합니다.  
