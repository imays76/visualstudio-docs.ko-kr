...
ms.locfileid: "47556973"
---
# <a name="moreinfourl-element-vsix-language-pack-schema"></a>MoreInfoURL 요소 (VSIX 언어 팩 스키마)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [MoreInfoURL 요소 (VSIX 언어 팩 스키마)](https://docs.microsoft.com/visualstudio/extensibility/moreinfourl-element-vsix-language-pack-schema)합니다.  
  
선택 사항입니다. 링크 확장에 대 한 지역화 된 정보입니다.  
