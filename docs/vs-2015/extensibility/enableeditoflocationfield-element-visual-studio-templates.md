...
이 항목의 최신 버전에서 찾을 수 있습니다 [EnableEditOfLocationField 요소 (Visual Studio 템플릿)](https://docs.microsoft.com/visualstudio/extensibility/enableeditoflocationfield-element-visual-studio-templates)합니다.  
