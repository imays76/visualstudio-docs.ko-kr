...
ms.locfileid: "47556810"
---
# <a name="sending-the-required-events"></a>필요한 이벤트 보내기
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [필요한 이벤트를 보내는](https://docs.microsoft.com/visualstudio/extensibility/debugger/sending-the-required-events)합니다.  
