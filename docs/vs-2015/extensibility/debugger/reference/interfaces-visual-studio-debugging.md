...
ms.locfileid: "47550727"
---
# <a name="interfaces-visual-studio-debugging"></a>인터페이스(Visual Studio 디버깅)
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [인터페이스 (Visual Studio 디버깅)](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/interfaces-visual-studio-debugging)합니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 인터페이스, 열거자 및 구조에 대 한 설명서는 [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] Debugging SDK.  
