...
ms.locfileid: "47542312"
---
# <a name="mparent-field"></a>m_parent 필드
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [m_parent 필드](https://docs.microsoft.com/visualstudio/extensibility/debugger/m-parent-field)합니다.  
  
에 대 한 지원 필드를 <xref:System.Threading.Tasks.Task?displayProperty=fullName> 부모 속성입니다.  
