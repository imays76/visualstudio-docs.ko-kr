...
ms.locfileid: "47554813"
---
# <a name="implementing-getmethodproperty"></a>GetMethodProperty 구현
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [GetMethodProperty 구현](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-getmethodproperty)합니다.  
