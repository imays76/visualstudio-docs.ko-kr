...
ms.locfileid: "47543781"
---
# <a name="attaching-and-detaching-to-a-program"></a>프로그램 연결 및 분리
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [연결 및 프로그램에 분리](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-and-detaching-to-a-program)합니다.  
