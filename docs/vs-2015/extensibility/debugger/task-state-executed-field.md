...
ms.locfileid: "47556161"
---
# <a name="taskstateexecuted-field"></a>TASK_STATE_EXECUTED 필드
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [TASK_STATE_EXECUTED 필드](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-executed-field)합니다.  
