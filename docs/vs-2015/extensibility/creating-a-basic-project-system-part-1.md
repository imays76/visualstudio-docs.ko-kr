...
ms.locfileid: "47554046"
---
# <a name="creating-a-basic-project-system-part-1"></a>기본 프로젝트 시스템 만들기, 1부
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [기본 프로젝트 시스템, 1 부 만들기](https://docs.microsoft.com/visualstudio/extensibility/creating-a-basic-project-system-part-1)합니다.  
...
2.  AssemblyInfo.cs 파일을 복사 합니다 **속성** 폴더를 **Projects\SimpleProject** 폴더.  
  
3.  에 **Projects\SimpleProject** 라는 XML 파일을 추가 하는 폴더 `SimpleProject.myproj`합니다.  
  
    > [!NOTE]
    >  이 형식의 모든 프로젝트에 대 한 파일 이름 확장명은.myproj 합니다. 변경 하려는 경우 변경 해야 everywhere 연습에서 설명 합니다.  
  
4.  기존 콘텐츠를 다음 줄을 바꿉니다.  
...
6.  **속성** 창에서 **빌드 작업** AssemblyInfo.cs, Program.cs, SimpleProject.ico, 및를 SimpleProject.myproj **콘텐츠**, 해당 설정 **VSIX에 포함** 속성을 **True**합니다.  
...
5.  SimpleProjectFactory.cs에서 다음을 추가 `using` 기존 뒤의 문으로 `using` 문입니다.  
...
-   새 프로젝트 폴더로 SimpleProject.myproj, 프로젝트 템플릿 파일을 복사합니다. 복사본에 입력 된 이름에 따라 이름이 합니다 **새 프로젝트** 대화 상자. `ProjectGuid` 속성 값이 새 GUID로 대체 됩니다.  
...
1.  에 **리소스** 폴더 SimpleProjectNode.bmp 라는 비트맵 파일을 추가 합니다.  
