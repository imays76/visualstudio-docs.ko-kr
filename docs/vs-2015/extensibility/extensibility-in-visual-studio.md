...
## <a name="create-your-own-sdks"></a>사용자 고유의 Sdk 만들기  
 패키지를 만들고 고유한 플랫폼 및 확장 Sdk를 배포 하는 방법을 알아봅니다: [소프트웨어 개발 키트 만들기](../extensibility/creating-a-software-development-kit.md)합니다.  
...
## <a name="azure-sdk"></a>Azure SDK  
 Azure SDK를 사용 하도록 설정 하는 방법 알아보기: [Azure SDK를 사용 하도록 설정 하면](../extensibility/enabling-the-azure-sdk.md)합니다.
