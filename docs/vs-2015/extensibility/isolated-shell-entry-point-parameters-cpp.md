...
ms.locfileid: "47553569"
---
# <a name="isolated-shell-entry-point-parameters-c"></a>격리 셸 진입점 매개 변수 (c + +)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [격리 된 셸 항목 지점 매개 변수 (c + +)](https://docs.microsoft.com/visualstudio/extensibility/isolated-shell-entry-point-parameters-cpp)합니다.  
