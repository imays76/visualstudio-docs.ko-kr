...
ms.locfileid: "47556337"
---
# <a name="name-element-visual-studio-templates"></a>Name 요소(Visual Studio 템플릿)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [Name 요소 (Visual Studio 템플릿)](https://docs.microsoft.com/visualstudio/extensibility/name-element-visual-studio-templates)합니다.  
