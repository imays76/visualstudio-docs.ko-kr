...
ms.locfileid: "47552589"
---
# <a name="buildprojectonload-visual-studio-templates"></a>BuildProjectOnLoad(Visual Studio 템플릿)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [BuildProjectOnLoad (Visual Studio 템플릿)](https://docs.microsoft.com/visualstudio/extensibility/buildprojectonload-visual-studio-templates)합니다.  
