...
이 항목의 최신 버전에서 찾을 수 있습니다 [는 목록의 설치 된 코드 조각 (레거시)를 가져오는](https://docs.microsoft.com/visualstudio/extensibility/internals/walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation)합니다.  
