...
ms.locfileid: "47554016"
---
# <a name="project-configuration-object"></a>프로젝트 구성 개체
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [프로젝트 구성 개체](https://docs.microsoft.com/visualstudio/extensibility/internals/project-configuration-object)합니다.  
