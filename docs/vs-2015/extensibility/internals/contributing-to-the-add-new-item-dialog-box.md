...
ms.locfileid: "47541339"
---
# <a name="contributing-to-the-add-new-item-dialog-box"></a>새 항목 추가 대화 상자에 적용
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [새 항목 추가 대화 상자에 영향을 주는](https://docs.microsoft.com/visualstudio/extensibility/internals/contributing-to-the-add-new-item-dialog-box)합니다.  
