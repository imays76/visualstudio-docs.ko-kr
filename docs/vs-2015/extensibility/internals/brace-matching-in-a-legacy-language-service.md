...
## <a name="implementation"></a>구현  
 ...
 설명은 중괄호 입력가 중괄호 강조 표시를 트리거합니다 하는 방법, 항목의 "예제 구문 분석 작업" 섹션을 참조 하세요 [레거시 언어 서비스 파서 및 검사기](../../extensibility/internals/legacy-language-service-parser-and-scanner.md)합니다.  
