...
ms.locfileid: "47553768"
---
# <a name="saving-a-custom-document"></a>사용자 지정 문서 저장
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [는 사용자 지정 문서 저장](https://docs.microsoft.com/visualstudio/extensibility/internals/saving-a-custom-document)합니다.  
