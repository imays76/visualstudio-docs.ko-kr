...
ms.locfileid: "47542777"
---
# <a name="button-element"></a>Button 요소
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [Button 요소](https://docs.microsoft.com/visualstudio/extensibility/button-element)합니다.  
  
사용자가 상호 작용할 수 있는 요소를 정의 합니다. 다른 종류의 단추 수: 단추, MenuButton, 및 SplitDropDown 합니다.  
