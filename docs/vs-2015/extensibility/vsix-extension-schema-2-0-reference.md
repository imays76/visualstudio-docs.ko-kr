...
ms.locfileid: "47555030"
---
# <a name="vsix-extension-schema-20-reference"></a>VSIX 확장 스키마 2.0 참조
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [VSIX 확장 스키마 2.0 참조](https://docs.microsoft.com/visualstudio/extensibility/vsix-extension-schema-2-0-reference)합니다.  
