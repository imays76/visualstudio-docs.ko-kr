...
ms.locfileid: "47543962"
---
# <a name="syntax-coloring-in-custom-editors"></a>사용자 지정 편집기의 구문 색 지정
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

이 항목의 최신 버전에서 찾을 수 있습니다 [사용자 지정 편집기에서 구문 색 지정](https://docs.microsoft.com/visualstudio/extensibility/syntax-coloring-in-custom-editors)합니다.  
...
## <a name="non-core-editor-usage-of-a-language-services-colorizer"></a>언어 서비스의 Colorizer 비핵심 편집기 사용  
 ...
 이 작업을 수행 하기 위한 비핵심 편집기를 필요 합니다.  
  
1.  언어 서비스의 colorizer 개체를 가져올 (구현 `T:Microsoft.VisualStudio.TextManager.Interop.IVsColorizer` 고 <xref:Microsoft.VisualStudio.TextManager.Interop.IVsColorizer2>). VSPackage이 작업을 호출 하 여 수행 된 <xref:Microsoft.VisualStudio.TextManager.Interop.IVsLanguageInfo.GetColorizer%2A> 언어 서비스의 인터페이스에서 메서드.  
