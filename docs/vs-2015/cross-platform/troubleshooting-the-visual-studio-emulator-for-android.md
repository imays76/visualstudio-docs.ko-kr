...
이 항목의 최신 버전에서 찾을 수 있습니다 [Troubleshooting the Visual Studio Emulator for Android](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-the-visual-studio-emulator-for-android)합니다.  
