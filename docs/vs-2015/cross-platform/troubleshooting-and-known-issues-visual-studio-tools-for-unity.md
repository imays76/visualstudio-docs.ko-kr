...
이 항목의 최신 버전에서 찾을 수 있습니다 [문제 해결 및 알려진 문제 (Visual Studio Tools for Unity)](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-and-known-issues-visual-studio-tools-for-unity)합니다.  
