...
이 항목의 최신 버전에서 찾을 수 있습니다 [Visual Studio 정적 코드 분석을 사용 하 여 스토어 앱의 분석 c + + 코드 품질](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis)합니다.  
