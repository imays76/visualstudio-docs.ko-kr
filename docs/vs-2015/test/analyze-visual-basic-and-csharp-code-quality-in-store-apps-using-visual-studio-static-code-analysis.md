---
title: Visual Studio 정적 코드 분석을 사용 하 여 스토어 앱의 Visual Basic 및 C# 코드 품질 분석 | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
이 항목의 최신 버전에서 찾을 수 있습니다 [분석 Visual Basic 및 C# 코드 Visual Studio 정적 코드 분석을 사용 하 여 스토어 앱의 품질](https://docs.microsoft.com/visualstudio/test/analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis)합니다.  
