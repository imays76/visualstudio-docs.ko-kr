...
이 항목의 최신 버전에서 찾을 수 있습니다 [shim을 사용 하 여 단위 테스트를 위한 다른 어셈블리에서 응용 프로그램 격리를](https://docs.microsoft.com/visualstudio/test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing)입니다.  
