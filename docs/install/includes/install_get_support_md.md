...
ms.locfileid: "53307806"
---
## <a name="get-support"></a>지원 받기

때로는 무엇인가 잘못될 수도 있습니다. Visual Studio 설치에 실패하는 경우 단계별 지침은 [Visual Studio 2017 설치 및 업그레이드 문제 해결](../troubleshooting-installation-issues.md)을 참조하세요.
