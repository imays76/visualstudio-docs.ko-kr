...
2.  장치 또는 에뮬레이터에서 빌드 및 디버깅 확인:
  ...
  자세한 내용은 Microsoft DevOps 블로그의 [Visual Studio Emulator for Android 소개](https://blogs.msdn.microsoft.com/devops/2014/11/12/introducing-visual-studios-emulator-for-android/)를 참조하세요. 에뮬레이터를 작동하는 중 문제가 발생하면 [Visual Studio Emulator for Android 문제 해결](../cross-platform/troubleshooting-the-visual-studio-emulator-for-android.md)을 참조하세요. **도구 > Android > Android Emulator 관리자**를 선택하여 에뮬레이터에 대한 새로운 장치 프로필을 만들 수도 있습니다.
