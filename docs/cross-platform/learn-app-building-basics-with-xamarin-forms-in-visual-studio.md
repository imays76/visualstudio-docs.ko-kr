...
1.  **WeatherPage.xaml**의 콘텐츠를 아래 태그로 바꿉니다. 앞서 설명된 대로 `x:Name` 특성을 사용하여 이름이 지정된 요소는 코드에서 참조될 수 있습니다. 또한 Xamarin.Forms는 다양한 [레이아웃 옵션](/xamarin/xamarin-forms/user-interface/controls/layouts)을 제공합니다. 여기서 WeatherPage는 [Grid](http://developer.xamarin.com/api/type/Xamarin.Forms.Grid/) 및 [StackLayout](http://developer.xamarin.com/api/type/Xamarin.Forms.StackLayout/)을 사용하고 있습니다.
