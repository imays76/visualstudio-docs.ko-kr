...
## <a name="remarks"></a>설명  
 이 요소를 통해 생성 된 서식 파일에만 사용 해야는 [!INCLUDE[vsipprvsip](../extensibility/includes/vsipprvsip_md.md)]합니다.  
