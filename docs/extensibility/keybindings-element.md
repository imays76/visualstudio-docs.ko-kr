...
ms.locfileid: "31141417"
---
# <a name="keybindings-element"></a>KeyBindings 요소
키 바인딩 요소와 다른 KeyBindings 그룹화 키 바인딩 요소를 그룹화합니다.  
...
|[KeyBindings](../extensibility/keybindings-element.md)|그룹 키 바인딩 요소와 다른 KeyBindings 그룹화 합니다.|  
