...
4. **Ngen 우선 순위** (1과 3 사이의 정수)-The Ngen 우선 순위 수준에 설명 되어 있습니다 [Ngen.exe 우선 순위 수준을](https://msdn.microsoft.com/en-us/library/6t9t5wcf(v=vs.110).aspx#Anchor_3)합니다.
...
```xml
 ...
 >**참고:** 선호 하는 경우.csproj 파일을 직접 편집할 수 있습니다.
