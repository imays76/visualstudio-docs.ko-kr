...
XML 기반을 만들 수 있습니다 *.vsct* 파일에서 기존 명령 테이블 *.ctc* 소스 파일입니다. 이렇게 하면 활용 새 XML 기반 [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] 명령 테이블 (VSCT) 컴파일러 형식을 합니다.  
