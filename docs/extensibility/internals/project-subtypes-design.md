...
다단계 프로젝트 하위 형식  
 ...
 수준 다중 프로젝트 하위 집계를 기본 프로젝트를 프로젝트 하위 형식, 별로 집계 된 다음 추가 고급 프로젝트 하위 형식으로 집계는 세 가지 수준으로 구성 됩니다. 그림의 일부로 제공 되는 지 원하는 인터페이스의 일부에 중점을 두고는 [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] 프로젝트 하위 형식 아키텍처입니다.  
