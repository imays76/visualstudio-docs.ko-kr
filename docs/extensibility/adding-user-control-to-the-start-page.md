...
1.  사용자 정의 컨트롤에 대 한 XAML 파일을 엽니다. 에 `<Grid>` 요소를 컨트롤에 다음 행 정의 추가 합니다.  
...
1.  XAML 디자이너에서 두 번 클릭 합니다 **주소 설정** 단추 컨트롤에 추가 합니다.  
     ...
     합니다 *UserControl1.cs* 파일이 코드 편집기에서 열립니다.  
...
1. **솔루션 탐색기**에 시작 페이지를 열려면 *.xaml* 파일입니다.  
...
## <a name="test-a-manually-created-custom-start-page"></a>수동으로 만든된 사용자 지정 시작 페이지를 테스트 합니다.  
