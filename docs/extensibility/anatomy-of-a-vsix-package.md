...
## <a name="installation-location"></a>설치 위치  
 ...
 기본적으로 설치에만 적용 됩니다는 현재 사용자 때문 *% LocalAppData %* 사용자별 디렉터리입니다. 그러나 설정 하는 경우는 [AllUsers](http://msdn.microsoft.com/en-us/ac817f50-3276-4ddb-b467-8bbb1432455b) 매니페스트를 요소의 `True`에서 확장을 설치할 *... \\* VisualStudioInstallationFolder*\Common7\IDE\Extensions* 되며 컴퓨터의 모든 사용자에 게 제공 됩니다.  
