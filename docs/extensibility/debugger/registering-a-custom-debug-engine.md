...
> [!NOTE]
>  일부분으로 빌드되는 TextInterpreter 샘플에서는 디버그 엔진을 등록 하는 방법의 예제를 찾을 수 있습니다 합니다 [자습서: ATL COM을 사용 하 여 디버그 엔진 구축](http://msdn.microsoft.com/en-us/9097b71e-1fe7-48f7-bc00-009e25940c24)합니다.  
