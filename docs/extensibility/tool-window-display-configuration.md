...
|이름|형식|데이터|설명|  
|----------|----------|----------|-----------------|  
|이름|REG_SZ|"짧은 이름 입력"|도구 창에 설명 하는 짧은 이름입니다. 레지스트리의 참조에만 사용 합니다.|  
...
|창|REG_SZ|*\<GUID &GT;*|GUID를 도구 창을 연결 하거나 수 탭 창입니다. GUID는 고유한 창 중 하나 또는 창 중 하나에 속할 수는 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] IDE.|  
...
|*\<GUID &GT;*|REG_DWORD 또는 REG_SZ|0 또는 설명 문자열입니다.|선택 사항입니다. 항목의 이름은 가시성 요구 명령의 GUID 여야 합니다. 값은 방금 정보 문자열을 보유합니다. 값은 일반적으로 `reg_dword` 0으로 설정 합니다.|  
