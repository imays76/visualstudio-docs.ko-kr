...
2.  복사를 *AssemblyInfo.cs* 에서 파일을 *속성* 폴더를 *Projects\SimpleProject* 폴더입니다.  
...
6.  에 **속성** 창에서 설정 합니다 **빌드 작업** 의 *AssemblyInfo.cs*, *Program.cs*, *SimpleProject.ico* , 및 *SimpleProject.myproj* 하 **콘텐츠**를 설정 하 고 해당 **VSIX에 포함** 속성을 **True**.  
...
3.  클래스 맨 위에 추가 *SimpleProject* 폴더가 *SimpleProjectFactory.cs*합니다.  
...
5.  GUID 특성을 추가 합니다 `SimpleProjectFactory` 클래스입니다. 특성의 값은 새 프로젝트 팩터리 GUID.  
