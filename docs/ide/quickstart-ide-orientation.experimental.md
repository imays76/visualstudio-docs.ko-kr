...
Visual Studio를 시작한 후 처음으로 보게 되는 것은 **시작 페이지**일 것입니다. **시작 페이지**는 필요한 명령과 프로젝트 파일을 빠르게 찾아볼 수 있는 “허브”로 디자인되었습니다. **최근 항목** 섹션에는 최근에 작업한 프로젝트 및 폴더가 표시됩니다. **새 프로젝트** 아래에서 링크를 클릭하여 **새 프로젝트** 대화 상자를 표시하거나, **열기** 아래에서 기존 코드 프로젝트 또는 폴더를 열 수 있습니다. 오른쪽에는 최신 개발자 뉴스 피드가 있습니다.

![Visual Studio의 시작 페이지](media/start-page-dark.png)

**시작 페이지**를 닫았다가 다시 보려면 **파일** 메뉴에서 다시 열 수 있습니다.

![Visual Studio의 파일 메뉴](media/file-menu-start-page-dark.png)

## <a name="create-a-project"></a>프로젝트 만들기

Visual Studio의 기능을 계속 탐색하기 위해 새 프로젝트를 만들어 보겠습니다.

1. **시작 페이지**의 **새 프로젝트** 아래에 있는 검색 상자에 **콘솔**을 입력하여 프로젝트 형식 목록을 이름에 "콘솔"이 포함된 항목으로 필터링합니다.

   ![Visual Studio 시작 페이지에서 프로젝트 템플릿 검색](media/start-page-search-templates-dark.png)
...
1. 표시되는 **새 프로젝트** 대화 상자에서 기본 프로젝트 이름을 그대로 사용하고 **확인**을 선택합니다.
   ...
   프로젝트가 만들어지고 **편집기** 창에 *Program.vb*라는 파일이 열립니다. **편집기**에는 파일 내용이 표시되며, 여기서 Visual Studio에서 하는 코딩 작업 대부분을 수행합니다.

   ![Visual Studio의 편집기](media/editor-dark.png)
...
![Visual Studio의 솔루션 탐색기](media/solution-explorer-console-app-dark.png)

## <a name="menus"></a>메뉴

Visual Studio의 위쪽에 따라 있는 메뉴 모음은 명령을 범주로 그룹화합니다. 예를 들어 **프로젝트** 메뉴에는 작업 중인 프로젝트와 관련된 명령이 포함되어 있습니다. **도구** 메뉴에서 **옵션**을 선택하여 Visual Studio 동작 방법을 사용자 지정하거나, **도구 및 기능 가져오기**를 선택하여 설치에 기능을 추가할 수 있습니다.

![Visual Studio의 메뉴 모음](media/menu-bar-dark.png)
...
![Visual Studio의 오류 목록](media/error-list-dark.png)
...
![Visual Studio의 출력 창](media/output-window-dark.png)
...
1. **세부 정보 표시**를 **빠른 실행** 상자에 입력합니다. 표시된 결과의 **옵션** 범주 아래에서 **프로젝트 및 솔루션 -> 빌드 및 실행**을 선택합니다.

   ![Visual Studio의 빠른 실행 상자](media/quick-launch-verbosity-dark.png)
...
1. **솔루션 탐색기**에서 **ConsoleApp1** 프로젝트를 마우스 오른쪽 단추로 클릭하고 팝업 메뉴에서 **다시 빌드**를 선택하여 프로젝트를 다시 빌드합니다.
   ...
   ![Visual Studio의 세부 정보 표시 빌드 출력](media/build-output-verbose-dark.png)
...
![Visual Studio의 사용자 의견 보내기 메뉴](media/send-feedback-dark.png)
