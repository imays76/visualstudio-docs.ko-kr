...
4.  **프로젝트 디자이너**에서 **게시** 페이지를 찾고 **게시 위치**를 *C:\TEMP*로 설정합니다.

5.  **지금 게시**를 클릭하여 프로젝트를 게시합니다.

     매니페스트 파일은 빌드되고 *C:\TEMP\CSWinApp_1_0_0_0\CSWinApp.exe.manifest*에 배치됩니다. 매니페스트를 보려면 파일을 마우스 오른쪽 단추로 클릭하고, **연결 프로그램**을 클릭하고, **목록에서 프로그램 선택**을 선택하고 나서, **메모장**을 클릭합니다.
...
6.  **프로젝트 디자이너**에서 **빌드 이벤트** 탭을 클릭하고 **빌드 후 편집** 단추를 클릭합니다.
