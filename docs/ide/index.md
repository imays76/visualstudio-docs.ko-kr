...
description: Visual Studio를 통해 다양한 프로그래밍 언어를 사용하여 앱을 개발하는 방법에 대해 알아봅니다.
ms.date: 01/01/2018
layout: LandingPage
author: gewarren
ms.author: gewarren
...
ms.locfileid: "53027278"
---
# <a name="visual-studio-documentation"></a>Visual Studio 설명서

Visual Studio를 통해 다양한 프로그래밍 언어를 사용하여 앱을 개발하는 방법에 대해 알아봅니다.
자습서, 비디오 및 기타 설명서에서 Visual Studio를 사용하여 코드와 앱을 만드는 방법을 설명합니다.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Visual Studio를 설치하고 설정하는 방법 알아보기</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Microsoft Virtual Academy의 Visual Studio 2017</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="experience-visual-studio-with-5-minute-quickstarts"></a>5분 "빠른 시작"을 사용하여 Visual Studio 사용
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Basic을 사용하여 콘솔 앱 만들기</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="go-deeper-with-tutorials"></a>자습서 자세히 알아보기
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>디버깅</span></a></div>