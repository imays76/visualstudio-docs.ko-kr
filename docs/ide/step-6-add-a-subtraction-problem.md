...
2.  "Fill in the subtraction problem" 주석 뒤에 다음 코드를 추가합니다.
     ...
     ![IntelliSense 창 도구 설명](../ide/media/express_overloads.png)
**IntelliSense** 창 도구 설명
     ...
     ![IntelliSense에서 Next&#40;&#41; 메서드의 오버로드](../ide/media/express_nextoverload.png)**IntelliSense**에서 **Next()** 메서드의 오버로드
...
5.  코드를 저장하고 실행합니다.
     ...
     ![뺄셈 문제가 있는 수학 퀴즈](../ide/media/express_addsubtract.png)
뺄셈 문제가 있는 **수학 퀴즈**
