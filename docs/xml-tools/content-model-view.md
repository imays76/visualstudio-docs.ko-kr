...
## <a name="workspace-panel"></a>작업 영역 패널
 ...
 작업 영역에 노드를 추가, 노드 목록에 표시 됩니다는 **작업 영역** 콘텐츠 모델 뷰의 패널입니다. 노드를 선택 하는 경우는 **작업 영역** 패널 콘텐츠 모델 뷰 디자인 화면에 나타납니다. 작업 영역에서 노드를 삭제 하려면 XSD 디자이너 도구 모음을 사용 합니다 **작업 영역** 패널 상황에 맞는 메뉴 또는 **삭제** 키입니다.
...
## <a name="xml-editor-integration"></a>XML 편집기 통합
 ...
 사이 전환할 수 있습니다 합니다 **XSD 디자이너** 및 상황에 맞는 메뉴를 사용 하 여 XML 편집기입니다.
