...
|XAML의 WPF 버전을 사용하는 데스크톱 응용 프로그램 디자인 | [Windows Presentation Foundation 시작](../designers/getting-started-with-wpf.md) |
| Visual Studio에서 DirectX 응용 프로그램 개발 | [게임 및 앱을 위한 3D 자산 작업](../designers/working-with-3-d-assets-for-games-and-apps.md) |
