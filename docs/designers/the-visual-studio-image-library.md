...
이미지 라이브러리는 다섯 가지 범주로 나뉩니다. 일반적인 요소, 작업, 주석, 아이콘 및 개체. 공통 요소 및 아이콘 형식에 대한 PDF 형식의 Readme 파일이 포함되어 있습니다. 여기에는 응용 프로그램에서 이러한 이미지를 적절하게 사용하는 방법에 대한 정보가 포함되어 있습니다.
