...
##  <a name="Path"></a> 패스 그리기
 ...
 ![펜 도구](../designers/media/717956a8-b6a5-4e37-8af3-70bcfc78c82a.png) ![펜 도구 옵션](../designers/media/8fbbbb21-be83-4cf6-903b-3a49f00c9860.png)

### <a name="draw-a-straight-line"></a>직선 그리기
 **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png) 또는 **줄** 도구 ![줄 도구](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png)를 사용합니다.

 **펜 도구 사용** ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)

 아트보드에서 한 번 클릭하여 시작 점을 정의한 후 다시 클릭하여 줄의 끝을 정의합니다.

 **줄 도구 사용** ![줄 도구](../designers/media/eb618397-5283-48be-8396-3449be7b6fbf.png)

 아트보드에서 줄을 시작할 위치에서 마우스를 끌어 줄을 끝낼 지점에서 마우스를 놓습니다.

### <a name="draw-a-curve"></a>곡선 그리기
 **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)를 사용합니다.
 ...
 **직접 선택** 도구 ![직접 선택 도구](../designers/media/6dd6571f-c116-451d-8dd2-1f88b8406362.png)를 사용합니다.

 도형을 클릭하고 도형에서 아무 점을 마우스로 끌어 곡선 모양을 변경합니다.

### <a name="draw-a-free-form-path"></a>자유형 패스 그리기
 **연필** 도구 ![연필 도구](../designers/media/509dc167-734f-46c9-b012-987ee63450cd.png)를 사용합니다.
 ...
 **선택** 도구 ![선택 도구](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) 및 **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)를 사용합니다.

 **선택** 도구 ![선택 도구](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)를 사용하여 경로를 선택합니다. 그런 다음, **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)를 사용하여 제거하려는 점을 클릭합니다.

### <a name="add-a-point-to-a-path"></a>패스에 점 추가
 **선택** 도구 ![선택 도구](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png) 및 **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)를 사용합니다.

 **선택** 도구 ![선택 도구](../designers/media/2ff91340-477e-4efa-a0f7-af20851e4daa.png)를 사용하여 경로를 선택합니다. **펜** 도구 ![펜 도구](../designers/media/894f8612-e0ed-4e00-84cf-a9bc8f38fc54.png)를 사용하여 경로에서 점을 추가할 위치를 클릭합니다.
...
|||||
|-|-|-|-|
|![결합하기 전의 두 도형](../designers/media/b1_1.png)|결합하기 전의 두 도형|![교차](../designers/media/b1_4.png)|교차|
