...
|.NET을 처음 사용하세요?|[.NET Framework의 개요](/dotnet/framework/get-started/overview)<br /><br /> [애플리케이션 주요 사항](/dotnet/standard/application-essentials)<br /><br /> [Visual C# 및 Visual Basic 시작](../ide/quickstart-visual-basic-console.md)|
