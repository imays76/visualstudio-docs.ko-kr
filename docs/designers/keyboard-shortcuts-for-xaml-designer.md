...
|모든 요소 선택|**Ctrl**+**A** 키를 누릅니다.|
|모든 요소 선택 지우기|**Ctrl**+**Shift**+**A** 키를 누릅니다.|
|요소 핸들 표시 또는 숨기기|**F9** 키를 누릅니다.|
|요소의 속성 선택|요소를 선택하고 속성 창에 포커스를 둔 상태에서 **Tab** 키를 누릅니다. (속성 창으로 포커스를 변경하려면 **Ctrl**+**Tab** 키를 사용합니다.) 화살표 키를 사용하여 드롭다운 목록에서 속성 값을 선택할 수 있습니다.|
