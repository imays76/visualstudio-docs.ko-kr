...
1.  **솔루션 탐색기**에서 셰이더를 추가할 프로젝트의 바로 가기 메뉴를 연 다음, **추가** > **새 항목**을 선택합니다.
...
|[모델 편집기](../designers/model-editor.md)|[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 모델 편집기를 사용하여 3D 모델 작업을 수행하는 방법을 설명합니다.|