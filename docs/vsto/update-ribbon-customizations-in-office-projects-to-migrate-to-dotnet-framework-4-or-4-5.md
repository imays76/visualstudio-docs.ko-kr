...
4.  Visual C# 프로젝트에서 <xref:System.EventHandler%601> 대리자를 사용하는 `InitializeComponent` 메서드의 코드 줄을 특정 리본 대리자를 대신 사용하도록 수정합니다.  
    ...
    <CodeContentPlaceHolder>9</CodeContentPlaceHolder>  
     리본 대리자의 전체 목록을 참조 하세요 [처리 리본 이벤트](#ribbonevents)합니다.  
...
## <a name="set-the-position-of-a-ribbon-component-programmatically"></a>리본 요소의 위치를 프로그래밍 방식으로 설정 합니다.  
