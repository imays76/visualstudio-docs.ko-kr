...
## <a name="create-document-level-projects-for-excel"></a>Excel 용 문서 수준 프로젝트를 만들려면  
 ...
 Excel 용 문서 수준 프로젝트를 만드는 방법에 대 한 자세한 내용은 참조 [하는 방법: Visual Studio에서 Office 만들기 프로젝트](../vsto/how-to-create-office-projects-in-visual-studio.md)합니다. 프로젝트 템플릿에 대 한 자세한 내용은 참조 [Office 프로젝트 템플릿 개요](../vsto/office-project-templates-overview.md)합니다.  
  
## <a name="program-excel-workbooks-by-using-host-items-and-host-controls"></a>사용 하 여 프로그램 Excel 통합 문서 호스트 항목 및 호스트 컨트롤  
...
## <a name="use-data-binding"></a>데이터 바인딩을 사용 하 여  
...
## <a name="next-steps"></a>다음 단계  
 Excel 용 문서 수준 사용자 지정을 만드는 방법을 알아보려면 참조 [연습: Excel 용 첫 문서 수준 사용자 지정 만들기](../vsto/walkthrough-creating-your-first-document-level-customization-for-excel.md)합니다. 이 연습에서는 Visual Studio 및 Excel 문서 수준 사용자 지정에 대 한 프로그래밍 모델의 Office 개발 도구를 소개합니다.  
