---
title: '방법: 프로그래밍 방식으로 범위를 만들 때 단락 표시를 제외'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35673930"
---
# <a name="how-to-programmatically-exclude-paragraph-marks-when-creating-ranges"></a>방법: 프로그래밍 방식으로 범위를 만들 때 단락 표시를 제외
