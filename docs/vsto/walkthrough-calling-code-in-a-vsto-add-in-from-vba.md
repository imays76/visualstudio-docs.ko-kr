...
## <a name="test-the-vsto-add-in"></a>VSTO 추가 기능을 테스트 합니다.  
 몇 가지 유형의 Office 솔루션에서 `AddInUtilities` 클래스를 호출할 수 있습니다. 이 연습에서는 Excel 통합 문서에서 VBA 코드를 사용합니다. 다른 유형의 Office 솔루션을 사용할 수도 있습니다에 대 한 자세한 내용은 참조 하세요. [다른 Office 솔루션에서 VSTO 추가 기능의 코드 호출](../vsto/calling-code-in-vsto-add-ins-from-other-office-solutions.md)합니다.  
...
6.  다음 VBA 코드를 코드 파일에 추가합니다. 이 코드는 먼저 나타내는 COMAddIn 개체를 가져옵니다 합니다 **ExcelImportData** 에서 VSTO 추가 기능입니다. 그런 다음 코드를 사용 하 여 COMAddIn 개체의 개체 속성을 호출 합니다 `ImportData` 메서드.  
