...
## <a name="host-controls"></a>호스트 컨트롤  
 호스트 컨트롤은 Word 및 Excel 개체 모델에서 다양 한 사용자 인터페이스 (UI) 개체를 같은 확장할 `Microsoft.Office.Interop.Word.ContentControl` 고 <xref:Microsoft.Office.Interop.Excel.Range> 개체입니다.  
