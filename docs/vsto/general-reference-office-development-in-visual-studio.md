...
## <a name="in-this-section"></a>단원 내용  
 ...
 Office 솔루션에서 응용 프로그램 매니페스트 사용 되는 방법을 설명 합니다.  
...
## <a name="related-sections"></a>관련 단원  
 ...
 코드 샘플 및 구문과 구조, Office 솔루션을 빌드하는 데 사용 되는 기술을 사용 하 여 학습 하는 데 도움이 되는 Visual Studio에서 Office 프로젝트를 만들기 위한 단계별 연습에 설명 합니다.  
