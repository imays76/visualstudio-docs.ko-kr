---
title: '방법: 프로그래밍 방식으로 Office 문서에서 데이터 소스를 캐싱'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35256707"
---
# <a name="how-to-programmatically-cache-a-data-source-in-an-office-document"></a>방법: 프로그래밍 방식으로 Office 문서에서 데이터 소스를 캐싱
...
## <a name="see-also"></a>참고자료  
 ...
 [데이터를 저장 합니다.](/visualstudio/data-tools/saving-data)  
