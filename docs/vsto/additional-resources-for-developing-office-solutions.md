...
# <a name="additional-resources-to-develop-office-solutions"></a>Office 솔루션을 개발 하는 추가 리소스
 ...
 OBA(Office 비즈니스 애플리케이션)에 대한 중앙 포털입니다. OBA는 Microsoft Office 애플리케이션을 통해 LOB(기간 업무) 시스템과 그 사용자를 연결하므로 혁신적인 방법으로 리소스를 결합하여 기존 IT 투자를 확장할 수 있습니다.  
