...
## <a name="cant-update-or-publish-to-a-network-file-share"></a>업데이트 또는 네트워크 파일 공유에 게시할 수 없습니다.  
 하는 경우 네트워크 파일 공유에 있는 office 솔루션 업데이트 중에 잘못 된 메시지가 표시 될 수 있습니다 솔루션의 *Setup.exe* 업데이트를 게시 하는 동안 프로세스에서 파일이 잠겨 있습니다. 나타나는 메시지는 "'setup.exe'를 웹 사이트에 추가할 수 없습니다. 이 웹 사이트에 'setup.exe' 파일이 이미 있습니다."입니다.  
