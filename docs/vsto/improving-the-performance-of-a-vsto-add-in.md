...
2.  스크립트를 사용하여 레지스트리를 업데이트하는 빌드 후 이벤트를 만듭니다.  
    ...
    ```  
     ...
     빌드 후 이벤트를 만드는 방법에 대 한 정보에 대 한는 C# 프로젝트를 참조 하세요 [방법: 지정 빌드 이벤트 &#40;C&#35;&#41;](/visualstudio/ide/how-to-specify-build-events-csharp)합니다.  
  
     Visual Basic 프로젝트에서 빌드 후 이벤트를 만드는 방법에 대 한 자세한 내용은 [방법: 지정 빌드 이벤트 &#40;Visual Basic&#41;](/visualstudio/ide/how-to-specify-build-events-visual-basic)합니다.  
