...
Express는 웹 응용 프로그램 프레임워크로, Node.js가 웹 응용 프로그램을 빌드하기 위한 서버 프레임워크로 사용됩니다. Express를 사용하면 Pug(이전의 Jade) 같은 UI를 만들기 위해 다양한 프런트 엔드 프레임 워크를 선택할 수 있습니다. Pug가 이 자습서에 사용됩니다.
