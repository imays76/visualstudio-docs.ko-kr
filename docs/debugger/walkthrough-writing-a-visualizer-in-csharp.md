...
> [!NOTE]
>  표시되는 대화 상자와 메뉴 명령은 실제 설정이나 버전에 따라 도움말에서 설명하는 것과 다를 수 있습니다. 로 이동 설정을 변경 합니다 **도구** 메뉴 선택 **설정 가져오기 및 내보내기**합니다. 자세한 내용은 [Visual Studio IDE 개인 설정](../ide/personalizing-the-visual-studio-ide.md)을 참조하세요.  
...
2.  에 **새 프로젝트** 대화 상자의 **Visual C#** 를 선택한 후 **.NET Standard**합니다.  
...
2.  에 **새 프로젝트** 대화 상자의 **Visual C#** 를 선택 **.NET Standard**합니다.  
...
3.  에 **새 항목 추가** 대화 상자의 **Visual C# 항목**를 선택 **디버거 시각화 도우미**합니다.  
