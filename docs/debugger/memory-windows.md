...
ms.locfileid: "49919470"
---
# <a name="use-the-memory-windows-in-the-visual-studio-debugger"></a>Visual Studio 디버거에서 메모리 Windows를 사용 합니다.
...
2. 에 **디버깅할** 메뉴에서 **Windows**합니다. 가리킨 **메모리** 을 클릭 한 다음 **메모리 1**를 **메모리 2**, **메모리 3**, 또는 **메모리 4**합니다. (하위 에디션의 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 하나뿐일 **메모리** 창입니다. 이러한 버전 중 하나를 사용 하는 경우 클릭할 **메모리**.)  
