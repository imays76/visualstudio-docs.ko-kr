---
title: IntelliTrace 뒤로 사용 하 여 스냅숏 보기
...
ms.locfileid: "46495762"
---
# <a name="view-snapshots-using-intellitrace-step-back-in-visual-studio"></a>Visual Studio에서 IntelliTrace 뒤로 사용 하 여 스냅숏 보기
