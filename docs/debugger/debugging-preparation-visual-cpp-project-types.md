...
##  <a name="BKMK_Windows_Forms_Applications___NET_"></a> Windows Forms 응용 프로그램 (.NET)  
 합니다 **Windows Forms 응용 프로그램 (.NET)** 템플릿은 만듭니다는 [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] Windows Forms 응용 프로그램입니다. 자세한 내용은 [How to: Create a Windows Application Project](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/42wc9kk5(v=vs.100))을 참조하세요.  
