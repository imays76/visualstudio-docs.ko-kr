...
ms.locfileid: "51561827"
---
# <a name="what-is-debugging"></a>새로운를 디버그 하시 나요?
...
이 문서에서는 몇 가지 일반적인 디버깅 개념에 알아보았습니다. 다음으로 Visual Studio를 사용 하 여 디버그 하는 방법 및 버그가 줄어들었습니다를 사용 하 여 코드를 작성 하는 방법을 학습을 시작할 수 있습니다.
