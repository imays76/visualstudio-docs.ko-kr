...
|**병렬 스택** 창|- 한 뷰에 표시되는 여러 스레드의 호출 스택입니다.<br />- 각 스레드에 대한 활성 스택 프레임입니다.<br />- 모든 메서드에 대한 호출자 및 호출 수신자입니다.|- 지정된 스레드 필터링<br />-작업 뷰로 전환 합니다.<br />- 스레드 플래그 설정 또는 해제<br />- 확대/축소|   
