...
-   Microsoft Test Manager의 테스트 세션에서 볼 [방법: 어려운 문제 디버그 도움이 되는 IntelliTrace 데이터 수집](/visualstudio/test/how-to-collect-intellitrace-data-to-help-debug-difficult-issues)합니다.
