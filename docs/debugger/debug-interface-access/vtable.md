...
|[IDiaSymbol::get_type](../../debugger/debug-interface-access/idiasymbol-get-type.md)|`IDiaSymbol*`|VTable의에 대 한 기호 [VTableShape](../../debugger/debug-interface-access/vtableshape.md)합니다.|  
