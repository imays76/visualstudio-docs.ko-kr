...
> [!NOTE]
>  기능 수준 문제를 염두에 둬야 하지만 여러 하드웨어 구성 및 장치에서 그래픽 로그 파일을 캡처 및 재생할 수 있습니다. 그래픽 로그는 로그 파일 Api를 포함 하지 않습니다 또는 재생 컴퓨터에서 지원 되지 않는 기능 수준을 사용 하는 동안 계속 다시 재생할 수 있습니다.  
