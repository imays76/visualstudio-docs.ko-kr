...
## <a name="see-also"></a>참고 항목  
 ...
 [연습: 음영으로 인 한 오류를 렌더링 디버깅](walkthrough-debugging-rendering-errors-due-to-shading.md)   
