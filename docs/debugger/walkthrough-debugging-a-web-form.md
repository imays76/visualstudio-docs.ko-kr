...
6.  **확인**을 클릭합니다.  
     ...
     [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]에서 새 프로젝트가 만들어지고 기본 HTML 소스 코드가 표시됩니다. 또한 명명 된 새 가상 디렉터리를 만듭니다 **웹 사이트** 아래에서 **기본 웹 사이트** IIS에서 합니다.  
