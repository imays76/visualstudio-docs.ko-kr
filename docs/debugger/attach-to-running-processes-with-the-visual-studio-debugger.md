...
1.  에 **사용 가능한 프로세스** 나열, 찾기 및 하나 이상의 프로세스에 연결 하려면 선택 합니다.  
...
1.  에 **연결할** 필드에 디버그 하려는 코드의 형식이 표시 되어 있는지 확인 합니다. 기본값 **자동** 대부분의 앱 형식에 대 한 작동을 설정 합니다. 
...
1.  **연결 형식** 있어야 **기본** 대부분의 경우에 대 한 합니다. 에 **연결 대상** 상자에서 다음 방법 중 하나를 사용 하 여 원격 컴퓨터를 선택 합니다.
...
1.  클릭 **새로 고침** 채우는 합니다 **사용 가능한 프로세스** 목록입니다.
