...
1.  프로젝트에 관련 된 데이터를 사용 하 여 데이터 원본의 다음 유형 중 하나를 추가 합니다.
    ...
    -   개체입니다. 자세한 내용은 [Visual Studio에서 개체를 바인딩할](bind-objects-in-visual-studio.md)합니다.
...
- [연습: WPF 응용 프로그램에서 관련된 데이터 표시](../data-tools/display-related-data-in-wpf-applications.md)