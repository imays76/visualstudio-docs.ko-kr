---
title: '연습: 단일 테이블 상속을 사용하여 LINQ to SQL 클래스 만들기(O-R 디자이너)'
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
6.  **도구 상자**의 **개체 관계형 디자이너** 탭에서 **Person** 및 **Employee** 개체 사이에 **상속**을 만듭니다. 이렇게 하려면 **도구 상자**에서 **상속** 항목을 클릭하고 마우스 단추를 놓으세요. 를 클릭 합니다 **직원** 개체 차례로 **사용자** 개체를 **O/R 디자이너**합니다. 상속 선의 화살표가 그러면 합니다 **Person** 개체입니다.
...
- [방법: Visual Basic의 개체 모델을 생성 또는C#](/dotnet/framework/data/adonet/sql/linq/how-to-generate-the-object-model-in-visual-basic-or-csharp)