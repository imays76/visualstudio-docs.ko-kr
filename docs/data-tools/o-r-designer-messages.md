...
## <a name="in-this-section"></a>단원 내용
 ...
 [데이터베이스 개체에 대 한 스키마 정보를 가져오지 못했습니다 \<개체 이름 >](../data-tools/could-not-retrieve-schema-information-for-database-object-object-name.md)
 ...
 [응용 프로그램 설정 파일에서 연결 속성이 없거나 잘못되었습니다.](../data-tools/the-connection-property-in-the-application-settings-file-is-missing-or-incorrect.md)
 ...
 [속성 \<속성 이름 >을 삭제할 수 없습니다](../data-tools/the-property-property-name-cannot-be-deleted.md)

 [속성 \<속성 이름 > 연결에 참여 하 고 있으므로 삭제할 수 없습니다 \<연결 이름 >](../data-tools/the-property-property-name-cannot-be-deleted-because-it-is-participating-in-the-association-association-name.md)
