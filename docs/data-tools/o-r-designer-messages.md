...
## <a name="in-this-section"></a>섹션 내용
 ...
 [데이터베이스 개체에 대 한 스키마 정보를 검색할 수 \<개체 이름 >](../data-tools/could-not-retrieve-schema-information-for-database-object-object-name.md)
 ...
 [속성 \<속성 이름 >은 삭제할 수 없습니다](../data-tools/the-property-property-name-cannot-be-deleted.md)

 [속성 \<속성 이름 >은 연결에 참여 하 고 있으므로 삭제할 수 없습니다 \<연결 이름 >](../data-tools/the-property-property-name-cannot-be-deleted-because-it-is-participating-in-the-association-association-name.md)
