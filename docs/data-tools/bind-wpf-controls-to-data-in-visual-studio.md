---
title: Visual Studio-1 부의에서 데이터에 WPF 컨트롤 바인딩 | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- data [WPF], displaying
...
다음 표에 항목을 끌어서 수행할 수 있는 작업이 합니다 **데이터 원본** 창에는 [!INCLUDE[wpfdesigner_current_short](../data-tools/includes/wpfdesigner_current_short_md.md)].
