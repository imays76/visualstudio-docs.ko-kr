...
## <a name="create-a-windows-forms-application"></a>Windows Forms 응용 프로그램을 만듭니다.
...
## <a name="add-a-user-control-to-the-project"></a>프로젝트에 사용자 정의 컨트롤을 추가합니다.

이 연습에서 복잡 한 데이터 바인딩 가능한 컨트롤을 만들기 때문에 **사용자 정의 컨트롤**, 추가 **사용자 정의 컨트롤** 프로젝트 항목:

1. 프로젝트 **메뉴에서 사용자 컨트롤 추가**를 선택합니다.

1. 이름 **영역에 ComplexDataGridView를 입력하고 추가**를 클릭합니다.
...
8.  `Customers` 테이블을 선택하고 마침**을 클릭합니다.
    ...
    NorthwindDataSet**가 프로젝트에 추가되고**  테이블이 데이터 소스`Customers` 창에 나타납니다.
...
데이터 소스** 창에서 폼으로 항목을 끌어 데이터 바인딩된 컨트롤을 만들 수 있습니다. 주 Customers **노드를 데이터 소스** 창에서 폼으로 끌어서 놓습니다. 있는지 확인 합니다 **ComplexDataGridView** 컨트롤은 테이블의 데이터를 표시 하는 데 사용 합니다.
