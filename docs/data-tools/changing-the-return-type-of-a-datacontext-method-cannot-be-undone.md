...
ms.locfileid: "36282757"
---
# <a name="changing-the-return-type-of-a-datacontext-method-cannot-be-undone"></a>DataContext 메서드의 반환 형식 변경은 취소할 수 없습니다.

DataContext 메서드의 반환 형식을 변경하면 실행 취소할 수 없습니다. 자동으로 생성 된 형식으로 되돌리려면 항목 끌어야 **서버 탐색기** 하거나 **데이터베이스 탐색기** O/R 디자이너로 다시 합니다. 반환 형식을 변경하시겠습니까?
...
1. 선택 합니다 <xref:System.Data.Linq.DataContext> 메서드는 [!INCLUDE[vs_ordesigner_short](../data-tools/includes/vs_ordesigner_short_md.md)] 삭제 합니다.

2. 항목을 찾아 **서버 탐색기/데이터베이스 탐색기** 끕니다는 [!INCLUDE[vs_ordesigner_short](../data-tools/includes/vs_ordesigner_short_md.md)]합니다.
