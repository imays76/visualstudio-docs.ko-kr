...
## <a name="rule-description"></a>규칙 설명  
 ...
 자세한 내용은 MSDN의 Microsoft Patterns and Practices 라이브러리에 있는 .NET 애플리케이션 성능 및 확장성 볼륨에서 5장 - 관리되는 코드 성능 향상의 [리플렉션 및 런타임 바인딩](http://go.microsoft.com/fwlink/?LinkId=177826) 섹션을 참조하세요.  
