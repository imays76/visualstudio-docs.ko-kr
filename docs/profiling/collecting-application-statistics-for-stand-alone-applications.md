...
|작업|관련 콘텐츠|  
|----------|---------------------|  
|**프로파일링을 사용하여 애플리케이션 시작**|-   [방법: 독립 실행형 애플리케이션 시작 및 애플리케이션 통계 수집](../profiling/how-to-launch-a-stand-alone-app-and-collect-application-statistics.md)|  
