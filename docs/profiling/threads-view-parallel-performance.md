...
## <a name="examine-specific-time-intervals-and-threads"></a>특정 시간 간격 및 스레드 검사  
...
### <a name="timeline-graph"></a>타임라인 그래프  
...
#### <a name="unblocking-stack"></a>스택 차단 해제  
...
#### <a name="io"></a>I/O  
 I/O 보고서에는 I/O 블록을 처리하는 호출과 각 호출 스택의 집계 차단 시간이 표시됩니다. 자세한 내용은 [I/O 시간(스레드 뷰)](../profiling/i-o-time-threads-view.md)을 참조하세요.  
