...
ms.locfileid: "37057920"
---
# <a name="work-with-the-python-interactive-window"></a>Python 대화형 창 사용
...
> [!Tip]
> 기본적으로 Visual Studio에서 대화형 창의 코드를 편집기에 붙여넣을 때 >>> 및 ... REPL 프롬프트는 제거됩니다. **도구 > 옵션 > 텍스트 편집기 > Python > 고급** 탭의 **붙여넣으면 REPL 프롬프트가 제거됨** 옵션을 사용하면 이 동작을 변경할 수 있습니다. [옵션 - 기타 옵션](python-support-options-and-settings-in-visual-studio.md#miscellaneous-options)을 참조하세요.
...
이 동작이 문제가 될 경우 [옵션 - 대화형 Windows 옵션](python-support-options-and-settings-in-visual-studio.md#interactive-windows-options)에 설명된 대로 **도구 > 옵션 > Python 도구 > 대화형 창** 아래의 **완료 모드** 그룹에서 설정을 변경합니다.
