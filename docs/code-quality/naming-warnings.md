...
|[CA1724: 형식 이름은 네임스페이스와 달라야 합니다.](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|형식 이름,.NET Framework 클래스 라이브러리에 정의 된 네임 스페이스의 이름을 일치 하지 해야 합니다. 이 규칙 위반 라이브러리의 사용 가능성을 줄일 수 있습니다.|
