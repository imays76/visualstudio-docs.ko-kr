...
## <a name="see-also"></a>참고 항목
 <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?displayProperty=fullName> [보안 코딩 지침](/dotnet/standard/security/secure-coding-guidelines) [데이터 및 모델링](/dotnet/framework/data/index) [링크 요구](/dotnet/framework/misc/link-demands)
