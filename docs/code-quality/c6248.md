...
```
 ...
 보안 설명자를 만드는 방법에는 전체 예제를 보려면를 참조 하세요 [c + +에서 새 개체에 대 한 보안 설명자를 만드는](http://msdn.microsoft.com/library/aa446595.aspx)합니다. 자세한 내용은 [DACL 만들기](/windows/desktop/SecBP/creating-a-dacl)합니다.