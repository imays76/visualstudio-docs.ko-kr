...
## <a name="see-also"></a>참고 항목
 [예외 및 예외 처리](/dotnet/csharp/programming-guide/exceptions/exceptions-and-exception-handling) [Ilasm.exe (IL 어셈블러)](/dotnet/framework/tools/ilasm-exe-il-assembler) [언어 독립성 및 언어 독립적 구성 요소](/dotnet/standard/language-independence-and-language-independent-components)