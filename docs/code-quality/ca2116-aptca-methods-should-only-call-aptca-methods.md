...
## <a name="see-also"></a>참고 항목
 [보안 코딩 지침](/dotnet/standard/security/secure-coding-guidelines) [신뢰할 수 있는 코드에서 라이브러리를 사용 하 여 부분적으로](/dotnet/framework/misc/using-libraries-from-partially-trusted-code) [링크 요구](/dotnet/framework/misc/link-demands) [데이터 및 모델링](/dotnet/framework/data/index)