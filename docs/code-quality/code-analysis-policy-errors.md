 ...
 **코드 분석 정책 실패 했습니다. 프로젝트에 오류가 있는 {0} 또는 최신 상태가 아닙니다.**
 ...
 **버전의 '{0}' 올바르지 않습니다. 강력한-지정 된 정책에 이름이 '{1}'.**
 ...
 **코드 분석 활성 구성에 사용 되지 않습니다. 구성으로 전환 {0} 프로젝트 빌드 및 {1} 체크 인하기 전에 합니다.**

 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], 활성 구성에는 코드 분석을 사용 하지만 하나 이상의 코드 분석을 사용 하도록 설정 합니다.

 **프로젝트에서 관리 되는 이진에 대 한 코드 분석을 활성화 해야 {0} 속성 및 체크 인 전에 빌드입니다.**
 ...
 **프로젝트에서 코드 분석을 활성화 해야 {0} 속성 및 체크 인 전에 빌드입니다.**
 ...
 **프로젝트에 C/c + + 코드 분석을 활성화 해야 {0} 속성 및 체크 인 전에 빌드입니다.**
