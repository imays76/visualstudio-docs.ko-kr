...
이 규칙 위반을 해결 하려면 매개 변수를 변경 된 <xref:System.Uri> 형식 주요 변경 내용입니다. 또는 사용 하는 메서드의 오버 로드를 제공는 <xref:System.Uri> 매개 변수입니다;이 줄 바꿈하지 않는 변경 내용입니다.
