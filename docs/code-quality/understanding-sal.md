...
2.  메뉴 모음에서 **빌드**, **솔루션에서 코드 분석 실행**합니다.
    ...
    > **잘못 된 매개 변수 값 C6387** '고정'는 '0' 일 수 없습니다: 'InCallee' 함수에 대 한 사양을 준수 하지 않습니다.
