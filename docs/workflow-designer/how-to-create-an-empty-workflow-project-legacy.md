---
title: '워크플로 디자이너-방법: 빈 워크플로 프로젝트 (레거시)'
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "31979440"
---
# <a name="how-to-create-an-empty-workflow-project-legacy"></a>방법: 빈 워크플로 프로젝트 만들기(레거시)

Visual Studio 2010에서 제공 되는 레거시 Windows 워크플로 디자이너를 사용 하 여 빈 워크플로 프로젝트를 만들려면 다음이 단계를 수행 합니다. WinFX 또는.NET Framework 버전 3.5 대상으로 해야 하는 경우 레거시 워크플로 디자이너를 사용 합니다.
