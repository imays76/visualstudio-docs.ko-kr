...
### <a name="add-the-publisher-to-the-trusted-publishers-store"></a>신뢰할 수 있는 게시자 저장소에 게시자 추가  
...
-   *CertMgr.exe*, Internet Explorer의 구성 요소 이며 따라서 Windows 98 및 모든 이후 버전에 존재 합니다. 자세한 내용은 [Certmgr.exe (인증서 관리자 도구)](/dotnet/framework/tools/certmgr-exe-certificate-manager-tool)합니다.  
...
>  테스트 인증서를 사용하여 응용 프로그램을 배포하는 것은 권장하지 않습니다.  
 ...
 사용 하 여 응용 프로그램에 서명할 수도 있습니다는 *Mage.exe* 하거나 *MageUI.exe* SDK 도구입니다. 자세한 내용은 [연습: ClickOnce 응용 프로그램을 수동으로 배포](../deployment/walkthrough-manually-deploying-a-clickonce-application.md)합니다. 배포 서명과 관련 된 명령줄 옵션의 전체 목록을 참조 하세요 [Mage.exe (매니페스트 생성 및 편집 도구)](/dotnet/framework/tools/mage-exe-manifest-generation-and-editing-tool)합니다.  
