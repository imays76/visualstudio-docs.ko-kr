...
ms.locfileid: "39151966"
---
# <a name="how-to-automatically-increment-the-clickonce-publish-version"></a>방법: 증분 ClickOnce 게시 버전 자동
...
## <a name="see-also"></a>참고자료  
 [방법: ClickOnce 게시 설정 버전](../deployment/how-to-set-the-clickonce-publish-version.md)   
