...
## <a name="comclass"></a>comClass  
 `comClass` 의 선택적 자식 요소입니다 합니다 `file` 요소인 하지만 필요한 경우는 [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] 등록-COM을 사용 하 여 배포 하려는 COM 구성 요소를 포함 하는 응용 프로그램 요소는 다음 특성을 가집니다.  
