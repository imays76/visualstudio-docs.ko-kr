...
<sup>1</sup> *포함: NFR(전매 금지), FTE, VSIP(Visual Studio 업계 파트너), BizSpark, MCT 소프트웨어 및 서비스 개발자. 제외: MPN(Microsoft 파트너 네트워크), Imagine, MVP(Microsoft Valued Partner), RD(Region Director), MCT 소프트웨어 및 서비스.*
