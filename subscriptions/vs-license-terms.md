...
3. **추가 사용 조건.** 다음 조항은 구독과 함께 제공되는 소프트웨어에 적용됩니다. 
   ...
   b. 
  **SCVMM(System Center - Virtual Machine Manager).** Visual Studio 고객은 Visual Studio Test Professional에서 랩 환경을 만들고 배포하고 관리하기 위해 Visual Studio Test Professional 소프트웨어를 통해 SCVMM을 설치하고 실행할 수 있습니다. 랩 환경은 응용 프로그램을 개발하고 테스트하기 위한 용도로만 사용되는 가상 운영 체제 환경입니다. 해당 용도에 대한 관리 라이선스는 필요하지 않습니다. 이 라이선스에 따라 가상화된 프로덕션 서버 관리와 같은 SCVMM의 다른 프로덕션 사용 권한은 제공되지 않습니다
