...
Visual Studio Enterprise 구독자는 6개월 동안 전체 Xamarin University 카탈로그에 액세스할 수 있습니다.  Visual Studio Professional 구독자는 3개월 동안 액세스할 수 있습니다.  

Visual Studio Dev Essentials 멤버는 선택한 무료 교육 과정, 게스트 강의, 두 개의 라이브 클래스, 번개 강의 기록 등에 대한 액세스가 포함된 체험 계정을 만들 수 있습니다.  
...
3.  “Microsoft Visual Studio용 Xamarin University 모바일 교육”이라는 Xamarin University 웹 페이지로 리디렉션됩니다.  **지금 구독 활성화**를 클릭합니다. 
    ...
    > [!NOTE]
    > 혜택을 받은 사용자로 로그인해야 한다는 오류가 표시되면 다음 단계를 따릅니다.
    > 1. Xamarin University가 포함된 브라우저 창을 닫습니다.
    > 2. my.visualstudio.com 포털에서 **로그아웃**을 클릭합니다.
    > 3. 모든 브라우저 창을 닫습니다. 
    > 4. 새 브라우저를 열고 [https://my.visualstudio.com](https://my.visualstudio.com)에 연결합니다.
...
| Visual Studio Professional(표준, 연간 클라우드) | VL, Azure, 일반 정품                                       | 3개월       |  예 |
...
### <a name="q--what-happens-when-my-free-subscription-expires"></a>Q: 체험 구독이 만료되면 어떻게 되나요?
A: Xamarin University 계정 및 진행 상태는 그대로 유지되지만 구독은 자료에 대한 액세스가 제한된 체험 계정으로 전환됩니다. 구독의 모든 혜택을 계속 유지하려면 [월간 구독을 구매](https://aka.ms/buy-xamarin-university)하면 됩니다.
