...
-   [JsValueRef Typedef](../chakra-hosting/jsvalueref-typedef.md)  
 ...
 다음 상수는 JsRT 호스팅을 지원합니다.  
  
-   [JS_INVALID_PROPERTYID 상수](../chakra-hosting/js-invalid-propertyid-constant.md)  
  
-   [JS_INVALID_REFERENCE 상수](../chakra-hosting/js-invalid-reference-constant.md)  
  
-   [JS_INVALID_RUNTIME_HANDLE 상수](../chakra-hosting/js-invalid-runtime-handle-constant.md)  
  
-   [JS_SOURCE_CONTEXT_NONE 상수](../chakra-hosting/js-source-context-none-constant.md)  
  
 다음 열거형은 JsRT 호스팅을 지원합니다.  
  
-   [JsErrorCode 열거형](../chakra-hosting/jserrorcode-enumeration.md)  
  
-   [JsMemoryEventType 열거형](../chakra-hosting/jsmemoryeventtype-enumeration.md)  
  
-   [JsPropertyIdType 열거형](../chakra-hosting/jspropertyidtype-enumeration.md)  
  
-   [JsRuntimeAttributes 열거형](../chakra-hosting/jsruntimeattributes-enumeration.md)  
  
-   [JsRuntimeVersion 열거형](../chakra-hosting/jsruntimeversion-enumeration.md)  
  
-   [JsTypedArrayType 열거형](../chakra-hosting/jstypedarraytype-enumeration.md)  
  
-   [JsValueType 열거형](../chakra-hosting/jsvaluetype-enumeration.md)  
