...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [디버그 속성 인터페이스](../../winscript/reference/debug-property-interfaces.md)  
  
 [디스패치 확장명 인터페이스](../../winscript/reference/dispatch-extension-interfaces.md)  
