...
|값|설명|  
|-----------|-----------------|  
|`S_OK`|메서드가 성공 하 고 현재 실행 중인 스레드 디버거 스레드입니다.|  
|`S_FALSE`|현재 실행 중인 스레드 디버거 스레드가 않습니다.|  
  
## <a name="remarks"></a>설명  
 이 메서드는 현재 실행 중인 스레드 디버거 스레드 인지 여부를 확인 합니다.  
