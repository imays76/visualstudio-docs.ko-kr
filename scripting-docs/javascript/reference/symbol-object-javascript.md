---
title: 기호 개체 (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24641303"
---
# <a name="symbol-object-javascript"></a>Symbol 개체(JavaScript)
고유 식별자를 만들 수 있습니다.  
...
|기호|설명|  
|------------|-----------------|  
|`Symbol.hasInstance`|이 메서드는 생성자 개체가 생성자의 인스턴스 중 하나로 개체를 인식 하는지 여부를 결정 합니다. `instanceof` 연산자에 의해 내부적으로 사용됩니다.|  
