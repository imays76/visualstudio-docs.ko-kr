...
## <a name="windows-runtime-errors"></a>Windows 런타임 오류  
 [!INCLUDE[win8_appname_long](../../javascript/includes/win8-appname-long-md.md)] 앱에서 Windows 런타임 API를 사용하는 경우 Windows 런타임 HRESULT에서 변환된 JavaScript 오류가 표시될 수 있습니다. 0x80070000 범위를 벗어나는 Windows 런타임 HRESULT는 낮은 비트의 16진수 값을 가져온 다음 10진수로 변환하는 방식을 통해 JavaScript 오류로 변환됩니다. 예를 들어 HRESULT 0x80070032는 10진수 값 50으로 변환되므로 여기에 해당하는 JavaScript 오류는 SCRIPT50입니다. HRESULT 0x80074005는 10진수 값 16389로 변환되므로 여기에 해당하는 JavaScript 오류는 SCRIPT16389입니다.  
...
|5019|[필요 합니다. ' &#93;'에서 정규식](../../javascript/misc/expected-right-square-bracket-in-regular-expression-javascript.md)|  
