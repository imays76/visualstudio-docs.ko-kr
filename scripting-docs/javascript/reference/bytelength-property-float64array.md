---
title: byteLength 속성 (Float64Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633843"
---
# <a name="bytelength-property-float64array"></a>byteLength 속성(Float64Array)
...
## <a name="example"></a>예제  
 다음 예제에서는 배열의 바이트 길이 가져오는 방법을 보여 줍니다.  
