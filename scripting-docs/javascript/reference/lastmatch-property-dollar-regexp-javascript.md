...
ms.locfileid: "24637843"
---
# <a name="lastmatch-property-amp-regexp-javascript"></a>lastMatch 속성 ($&amp;) (RegExp) (JavaScript)
정규식 검색에서 일치 하는 마지막 문자를 반환합니다. 읽기 전용입니다.  
...
## <a name="remarks"></a>설명  
 ...
 초기 값은 `lastMatch` 속성은 빈 문자열입니다. 값은 `lastMatch` 속성 때마다 변경 검색 됩니다.  
  
## <a name="example"></a>예제  
 다음 예제에서는 `lastMatch` 속성을 사용하는 방법을 보여 줍니다.  
