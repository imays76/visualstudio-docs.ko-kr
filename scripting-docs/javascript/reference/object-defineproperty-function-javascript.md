...
ms.locfileid: "24642123"
---
# <a name="objectdefineproperty-function-javascript"></a>Object.defineProperty 함수(JavaScript)
...
-   기존 속성의 특성을 수정합니다. 개체에 지정된 속성 이름이 있을 때 수행됩니다.  
 ...
 개체에 여러 속성을 추가 하거나 여러 기존 속성을 수정 하는 데는 [Object.defineProperties 함수](../../javascript/reference/object-defineproperties-function-javascript.md)합니다.  
...
-   개체는 [extensible](../../javascript/reference/object-isextensible-function-javascript.md) 이며 지정된 된 속성 이름이 존재 하지 않습니다.  
...
## <a name="adding-a-data-property"></a>데이터 속성 추가  
...
## <a name="modifying-a-data-property"></a>데이터 속성 수정  
...
## <a name="adding-an-accessor-property"></a>접근자 속성 추가  
...
## <a name="modifying-an-accessor-property"></a>접근자 속성 수정  
...
## <a name="modifying-a-property-on-a-dom-element"></a>DOM 요소의 속성 수정  
...
## <a name="requirements"></a>요구 사항  
 Internet Explorer 9 표준 모드 및 Internet Explorer 10 표준 모드와 [!INCLUDE[win8_appname_long](../../javascript/includes/win8-appname-long-md.md)] 앱에서는 모든 기능을 지원합니다.  
