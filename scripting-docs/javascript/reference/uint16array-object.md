...
## <a name="parameters"></a>매개 변수  
 `uint16Array`  
 필수 요소. 변수 이름은 **Uint16Array** 개체를 할당 합니다.  
 ...
 `byteOffset`  
 선택 사항입니다. 버퍼의 시작 지점에서 Uint16Array를 시작할 오프셋(바이트)을 지정합니다.  
...
|상수|설명|  
|--------------|-----------------|  
|[BYTES_PER_ELEMENT 상수](../../javascript/reference/bytes-per-element-constant-uint16array.md)|배열에서 각 요소의 크기(바이트)입니다.|  
...
## <a name="methods"></a>메서드  
 다음 표에서는 `Uint16Array` 개체의 메서드를 보여 줍니다.  
