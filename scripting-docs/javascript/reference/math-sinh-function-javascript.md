---
title: Math.sinh 함수 (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638603"
---
# <a name="mathsinh-function-javascript"></a>Math.sinh 함수(JavaScript)
숫자의 역쌍곡 사인을 반환합니다.  
...
## <a name="remarks"></a>설명  
 반환 값은 `(exp(x) - exp(-x))/2`와 동일합니다. x가 `NaN`인 경우, 결과는 `NaN`입니다.  
