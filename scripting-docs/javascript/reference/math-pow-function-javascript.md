---
title: Math.pow 함수 (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638773"
---
# <a name="mathpow-function-javascript"></a>Math.pow 함수(JavaScript)
지정된 된 거듭제곱을 수행 하는 기본 식의 값을 반환 합니다.  
