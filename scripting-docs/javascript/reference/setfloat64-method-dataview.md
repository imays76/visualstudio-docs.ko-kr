...
ms.locfileid: "24639963"
---
# <a name="setfloat64-method-dataview"></a>setFloat64 메서드(DataView)
보기의 시작 부분부터 지정 된 바이트 오프셋에서 Float64 값을 설정합니다. 맞춤 제약 조건이 없습니다. 모든 오프셋에서 멀티 바이트 값을 설정할 수 있습니다.  
...
## <a name="example"></a>예제  
 다음 예제에서는 DataView의 첫 번째 Float64를 설정 하는 방법을 보여 줍니다.  
