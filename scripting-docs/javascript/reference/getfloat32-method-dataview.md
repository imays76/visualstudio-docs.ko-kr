...
ms.locfileid: "24636503"
---
# <a name="getfloat32-method-dataview"></a>getFloat32 메서드(DataView)
보기의 시작 부분부터 지정 된 바이트 오프셋에서 Float32 값을 가져옵니다. 맞춤 제약 조건이 없습니다. 모든 오프셋에서 멀티 바이트 값을 가져올 수 있습니다.  
...
## <a name="parameters"></a>매개 변수  
 `testFloat`  
 필수 요소. 메서드에서 반환 되는 Float32 값입니다.  
...
## <a name="example"></a>예제  
 다음 예제에 DataView의 첫 번째 Float32를 가져오는 방법을 보여 줍니다.  
