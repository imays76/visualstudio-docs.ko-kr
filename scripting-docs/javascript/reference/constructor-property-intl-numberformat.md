---
title: constructor 속성 (Intl.NumberFormat) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636113"
---
# <a name="constructor-property-intlnumberformat"></a>constructor 속성(Intl.NumberFormat)
포맷터를 만드는 함수를 지정 합니다.  
...
## <a name="remarks"></a>설명  
 필요한 `numberFormatter` 포맷터의 이름입니다.  
