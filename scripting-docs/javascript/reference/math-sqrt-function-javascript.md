---
title: Math.sqrt 함수 (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638433"
---
# <a name="mathsqrt-function-javascript"></a>Math.sqrt 함수(JavaScript)
숫자의 제곱근을 반환합니다.  
...
## <a name="remarks"></a>설명  
 ...
 경우 `number` 가 음수 이면 반환 값은 `NaN`합니다.  
