---
title: getUint16 메서드 (DataView) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636673"
---
# <a name="getuint16-method-dataview"></a>getUint16 메서드(DataView)
보기의 시작 부분부터 지정 된 바이트 오프셋에서 Uint16 값을 가져옵니다. 맞춤 제약 조건이 없습니다. 모든 오프셋에서 멀티 바이트 값을 가져올 수 있습니다.  
...
## <a name="example"></a>예제  
 다음 예제에 DataView의 첫 번째 Uint16를 가져오는 방법을 보여 줍니다.  
