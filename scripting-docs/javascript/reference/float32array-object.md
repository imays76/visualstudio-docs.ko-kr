...
ms.locfileid: "24637313"
---
# <a name="float32array-object"></a>Float32Array 개체
...
## <a name="parameters"></a>매개 변수  
 `float32Array`  
 필수 요소. 변수 이름은 **Float32Array** 개체를 할당 합니다.  
...
|상수|설명|  
|--------------|-----------------|  
|[BYTES_PER_ELEMENT 상수](../../javascript/reference/bytes-per-element-constant-float32array.md)|배열에서 각 요소의 크기(바이트)입니다.|  
