---
title: Math.cos 함수 (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638543"
---
# <a name="mathcos-function-javascript"></a>Math.cos 함수(JavaScript)
숫자의 코사인을 반환합니다.  
...
## <a name="remarks"></a>설명  
 ...
 반환 값의 숫자 인수의 코사인 값은 `radians`합니다.  
