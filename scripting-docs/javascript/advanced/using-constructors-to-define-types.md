...
ms.locfileid: "24569183"
---
# <a name="using-constructors-to-define-types"></a>생성자를 사용하여 형식 정의
...
## <a name="constructor-examples"></a>생성자 예제  
...
```  
 ...
 생성자 함수는 새로 만든 빈 개체에 대한 참조인 **this** 키워드를 포함합니다. 속성을 만들고 초기 값을 지정하여 새 개체를 초기화합니다. 생성자는 생성한 개체에 대한 참조를 반환합니다.  
  
## <a name="writing-constructors"></a>생성자 작성  
...
```  
 ...
 사용자 지정 생성자를 사용하여 만든 모든 개체의 형식은 `object`입니다. JavaScript에는 `object`, `function`, `string`, `number`, `boolean` 및 `undefined`의 6가지 형식만 있습니다. 자세한 내용은 [typeof 연산자](../../javascript/reference/typeof-operator-decrementjavascript.md)를 참조하세요.  
